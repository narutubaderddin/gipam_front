...
(function () {
  ...
  var J = function (b) {
      var c, d, e;
      for (e in b) {
        if ((c = a.dialog.getContentElement(a.dialog._.currentTabId, e))) c = c.getElement();
        else if (b[e].instance) c = b[e].instance.getElement().getFirst() || b[e].instance.getElement();
        else continue;
    ...
    K = function (b) {
      ...
      for (e in b)
        (c = a.dialog.getContentElement(a.dialog._.currentTabId, e)),
          c || (c = b[e].instance),
          c.setLabel && ((d = b[e].localizationID || e), c.setLabel(a.LocalizationComing[d] + ':'));
    },
    t,
    A;
    ...
    var h = function (h) {
      ...
      h.data.getTarget().is('a') &&
        ...
        d.getElement().getChildCount()
          ...
          : (a.setIframe(d, c), (f = document.getElementById(e)), (a.targetFromFrame[e] = f.contentWindow)));
    };
  ...
  a.buildOptionLang = function (b, c) {
    ...
    for (e = 0; e < d.options.length; e++)
      d.options[e].value == a.selectingLang && (d.options[e].selected = 'selected');
  };
  ...
  var B = function (a) {
    ...
    L = function (b, c, d) {
      ...
      f.setAttributes({ type: 'radio', value: c, name: 'wscGrammerSuggest', id: k });
    ...
    w = function (b) {
      ...
      b.onchange = function (b) {
        ...
        g.postMessage.send({
          message: { changeLang: a.selectingLang, interfaceLang: a.interfaceLang, text: a.dataTemp, cmd: d },
        ...
        'undefined' == c &&
          (a.userDictionaryName
            ? ((c = a.userDictionaryName),
              ...
              g.postMessage.send({ message: d, target: a.targetFromFrame[void 0] }))
            : (c = ''));
    ...
    return {
      ...
      onShow: function () {
        ...
        if (CKEDITOR && CKEDITOR.config) {
          ...
          var d = 'file:' == document.location.protocol ? 'httpClient:' : document.location.protocol,
            d =
            ...
            b.plugins.scayt &&
              (b.wsc.isSsrvSame = (function () {
                ...
                window.SCAYT &&
                  ...
                  f.split('//'),
                  (g = f.split('//')[1].split('/')[0]),
                  (p = f.split(g + '/')[1].replace('/lf/scayt3/ckscayt/', '') + '/script/ssrv.cgi'));
                !d ||
                  f ||
                ...
                return (
                  '//' + a + c ===
                  '//' + (b.config.scayt_serviceHost || g || e) + '/' + (b.config.scayt_servicePath || p || h)
                );
              })());
      ...
      onHide: function () {
        ...
        if (b.plugins.scayt && b.wsc && b.wsc.isSsrvSame) {
          ...
          b.scayt
            ? (c
                ? (b.wsc.DataStorage.setData('scayt_user_dictionary_name', c), b.scayt.restoreUserDictionary(c))
                : (b.wsc.DataStorage.setData('scayt_user_dictionary_name', ''), b.scayt.removeUserDictionary()),
              e &&
                setTimeout(function () {
                  f = e.split(',');
            ...
            : (c
              ...
              e && ((f = e.split(',')), b.wsc.DataStorage.setData('scayt_user_dictionary', f)));
        }
      },
      contents: [
        {
  ...
  CKEDITOR.dialog.add('options', function (b) {
    ...
    return {
      ...
      onLoad: function () {
        ...
        d.IgnoreDomainNames = c.getContentElement('OptionsTab', 'IgnoreDomainNames');
      },
      onShow: function () {
