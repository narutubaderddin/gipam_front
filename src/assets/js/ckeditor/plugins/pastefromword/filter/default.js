      ...
      h = {
        ...
        elements: {
          a: function (a) {
            ...
            a.attributes.name &&
              w[a.attributes.name] &&
              ((a = w[a.attributes.name]), (a.attributes.href = a.attributes.href.replace(/.*#(.*)$/, '#$1')));
          },
          div: function (a) {
          ...
          td: function (a) {
            ...
            for (h = 0; h < e.length; h++) c[e[h]] && ((g = c[e[h]]), (d[g] = d[g] ? d[g] + 1 : 1));
            k.createStyleStack(
              a,
              p,
              b,
  ...
  CKEDITOR.plugins.pastefromword.styles = {
    ...
    normalizedStyles: function (a, b) {
      ...
      'cke:li' == a.name &&
        ...
        (h.MARGIN = h.MARGIN.replace(/(([\w\.]+ ){3,3})[\d\.]+(\w+$)/, '$10$3')));
    ...
    pushStylesLower: function (a, b, c) {
      ...
      var d = { 'list-style-type': !0, width: !0, height: !0, border: !0, 'border-': !0 },
        ...
        g;
      for (g in e)
        if (!(g.toLowerCase() in d || d[g.toLowerCase().replace(/\-.*$/, '-')] || g.toLowerCase() in b)) {
          for (var h = !1, l = 0; l < a.children.length; l++) {
            ...
            f.type === CKEDITOR.NODE_ELEMENT && ((h = !0), k.setStyle(f, g, e[g]));
          }
          h && delete e[g];
        }
      a.attributes.style = CKEDITOR.tools.writeCssText(e);
        ...
        if (g)
          for (g = g.cssRules, h = 0; h < g.length; h++)
            g[h].type === window.CSSRule.STYLE_RULE &&
              a.push({ selector: g[h].selectorText, styles: e(c(g[h].cssText)) });
        return a;
      },
      filter: function (a) {
  ...
  CKEDITOR.plugins.pastefromword.lists = {
    ...
    removeSymbolText: function (a) {
      ...
      a.forEach(function (d) {
        !b &&
          ...
          d.parent.getHtml().match(/^(\s|&nbsp;)*$/) && (b = d.parent !== a ? d.parent : null));
      }, CKEDITOR.NODE_TEXT);
      b && b.remove();
    },
    ...
    setListStart: function (a) {
      ...
      switch (a.attributes['cke-list-style-type']) {
        ...
        case 'lower-alpha':
        case 'upper-alpha':
          a.attributes.start = f.getSubsectionSymbol(b[c]).replace(/\W/g, '').toLowerCase().charCodeAt(0) - 96 - c;
          break;
        case 'decimal':
          a.attributes.start = parseInt(f.getSubsectionSymbol(b[c]), 10) - c || 1;
      }
      ...
      toNumber: function (a, b) {
        ...
        function d(a) {
          ...
          for (var c = b.length, d = 0, f = 0; f < c; ++f)
            for (var n = b[f], r = n[1].length; a.substr(0, r) == n[1]; a = a.substr(r)) d += n[0];
          return d;
        }
        return 'decimal' == b
          ? Number(a)
    ...
    createLists: function (a) {
      ...
      for (a = 0; a < g.length; a++) {
        ...
        for (d = 0; d < h.length; d++) {
          ...
          for (; c < l.length; )
            l.pop(), (k = l[l.length - 1]), c == l.length && f.setListSymbol(k, b.attributes['cke-symbol'], c);
          b.remove();
          k.add(b);
        }
        l[0].children.length &&
    ...
    calculateValue: function (a) {
      ...
      for (g = a; 0 <= g && null === c; g--)
        (e = b.children[g]),
          e.attributes && void 0 !== e.attributes.value && ((d = g), (c = parseInt(e.attributes.value, 10)));
    ...
    groupLists: function (a) {
      var b,
        ...
        e = d[0];
      c = a[0];
      c.attributes['cke-indentation'] = c.attributes['cke-indentation'] || f.getElementIndentation(c);
      ...
      for (var c = {}, d = [[]], e, g = 0; g < a.length; g++) {
        ...
        h
          ? ((n = h.type.match(/alpha/) && 7 == h.index ? 'alpha' : n),
            (n = 'o' == a[g].attributes['cke-symbol'] && 14 == h.index ? 'alpha' : n),
            (k = f.getSymbolInfo(a[g].attributes['cke-symbol'], n)),
            (l = this.getListItemInfo(a[g])),
            (h.type != k.type || (e && l.id != e.id && !this.isAListContinuation(a[g]))) && d.push([]))
          : (k = f.getSymbolInfo(a[g].attributes['cke-symbol']));
        for (e = parseInt(a[g].attributes['cke-list-level'], 10) + 1; 20 > e; e++) c[e] && delete c[e];
    ...
    getSymbolInfo: function (a, b) {
      ...
      if (a.match(/\d/)) return { index: a ? parseInt(f.getSubsectionSymbol(a), 10) : 0, type: 'decimal' };
  ...
  CKEDITOR.plugins.pastefromword.heuristics = {
    ...
    assignListLevels: function (a, b) {
      if (!b.attributes || void 0 === b.attributes['cke-list-level']) {
        for (
          var c = [f.getElementIndentation(b)], d = [b], e = [], g = CKEDITOR.tools.array, h = g.map;
