CKEDITOR.dialog.add('scaytDialog', function (c) {
        ...
        elements: [
          {
            ...
            children: (function () {
              var b = d.getApplicationConfig(),
                ...
                f;
              for (f in b) (b = { type: 'checkbox' }), (b.id = f), (b.label = d.getLocal(c[f])), a.push(b);
              return a;
            })(),
            onShow: function () {
              this.getChild();
            ...
            children: [
              { type: 'html', id: 'dictionaryNote', html: '' },
              {
                ...
                onShow: function (b) {
                  ...
                  h.isLicensed() || ((f.disabled = !0), b.css(f, { cursor: 'not-allowed' }));
                  setTimeout(function () {
                    a.getContentElement('dictionaries', 'dictionaryNote').getElement().setText('');
                    null != h.getUserDictionaryName() &&
                      '' != h.getUserDictionaryName() &&
                      a.getContentElement('dictionaries', 'dictionaryName').setValue(h.getUserDictionaryName());
                  }, 0);
                },
              },
              {
                ...
                children: [
                  {
                    ...
                    onLoad: function () {
                      ...
                      b.isLicensed() || (a.css(h, { cursor: 'not-allowed' }), a.css(f, { cursor: 'not-allowed' }));
                    },
                    onClick: function () {
                  ...
                  },
                  {
                    ...
                    onClick: function () {
                      ...
                      a.isLicensed() &&
                        ...
                        c.fire('scaytUserDictionaryAction', { dialog: b, command: 'disconnect', name: e }));
                    },
                  },
                  {
                    type: 'button',
                    ...
                    onClick: function () {
                      ...
                      a.isLicensed() &&
                        a.removeUserDictionary(
                          ...
                          function (a) {
                            f.setValue('');
                            a.error || h.toggleDictionaryState.call(b, 'initialState');
                            a.dialog = b;
                            a.command = 'remove';
                            a.name = e;
                            c.fire('scaytUserDictionaryAction', a);
    ...
    void 0 === b.data.error
      ...
      : ('' === b.data.name
        ...
        null != e.getUserDictionaryName() && '' != e.getUserDictionaryName()
          ? c.getContentElement('dictionaries', 'dictionaryName').setValue(e.getUserDictionaryName())
  ...
  c.on('scaytUserDictionaryActionError', function (b) {
    ...
    '' === b.data.name
      ...
      : ((g = e.getLocal('message_error_' + b.data.command + 'Dic')), (g = g.replace('%s', b.data.name)), d.setText(g));
    a.css(d.$, { color: 'red' });
    null != e.getUserDictionaryName() && '' != e.getUserDictionaryName()
      ? c.getContentElement('dictionaries', 'dictionaryName').setValue(e.getUserDictionaryName())
      : c.getContentElement('dictionaries', 'dictionaryName').setValue('');
  ...
  var g = {
    ...
    getChangedOption: function () {
      ...
      if (1 == c.config.scayt_uiTabs[0])
        for (var a = this.getContentElement('options', 'scaytOptions').getChild(), d = 0; d < a.length; d++)
    ...
    buildRadioInputs: function (b, a, d) {
      var f = new CKEDITOR.dom.element('div'),
        ...
        m = c.scayt;
      f.setStyles({ 'white-space': 'normal', position: 'relative', 'padding-bottom': '2px' });
    ...
    renderLangList: function (b) {
      ...
      for (l in e) k++, (m = l in f.ltr || l in f.rtl), this.buildRadioInputs(e[l], l, m).appendTo(k <= g ? a : b);
    },
