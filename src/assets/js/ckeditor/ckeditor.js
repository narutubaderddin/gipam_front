...
(function () {
    ...
    (CKEDITOR.event.prototype = (function () {
      ...
      return {
        ...
        on: function (b, d, h, k, g) {
          function m(e, a, y, x) {
            e = { name: b, sender: this, editor: e, data: a, listenerData: k, stop: y, cancel: x, removeListener: r };
          ...
          if (0 > e.getListenerIndex(d)) {
            ...
            for (var x = e.length - 1; 0 <= x; x--)
              if (e[x].priority <= g) return e.splice(x + 1, 0, m), { removeListener: r };
            e.unshift(m);
          }
  ...
  CKEDITOR.on(
    ...
    function (a) {
      if (window.console && window.console.log) {
        ...
        console[d](
          '[CKEDITOR] For more information about this error go to https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_errors-section-' +
            b
        );
      }
    },
    ...
    CKEDITOR.tools = {
      ...
      extend: function (a) {
        var e = arguments.length,
          b,
          c;
        'boolean' == typeof (b = arguments[e - 1])
          ? e--
          : 'boolean' == typeof (b = arguments[e - 2]) && ((c = arguments[e - 1]), (e -= 2));
        for (var g = 1; g < e; g++) {
          var d = arguments[g],
            m;
      ...
      cssStyleToDomStyle: (function () {
        var a = document.createElement('div').style,
          e =
            'undefined' != typeof a.cssFloat ? 'cssFloat' : 'undefined' != typeof a.styleFloat ? 'styleFloat' : 'float';
        return function (a) {
          return 'float' == a
            ? e
      ...
      buildStyleHtml: function (a) {
        ...
        for (var e, b = [], c = 0; c < a.length; c++)
          if ((e = a[c]))
            /@import|[{}]/.test(e)
              ? b.push('\x3cstyle\x3e' + e + '\x3c/style\x3e')
              : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + e + '"\x3e');
        return b.join('');
      },
      htmlEncode: function (a) {
        return void 0 === a || null === a
          ? ''
          : String(a).replace(b, '\x26amp;').replace(c, '\x26gt;').replace(f, '\x26lt;');
      },
      ...
      transformPlainTextToHtml: function (a, e) {
        ...
        c = c.replace(/\n/g, '\x3cbr\x3e');
        b ||
          (c = c.replace(new RegExp('\x3cbr\x3e(?\x3d\x3c/' + g + '\x3e)'), function (a) {
            return CKEDITOR.tools.repeat(a, 2);
          }));
        c = c.replace(/^ | $/g, '\x26nbsp;');
        return (c = c
          .replace(/(>|\s) /g, function (a, e) {
            return e + '\x26nbsp;';
          })
          .replace(/ (?=<)/g, '\x26nbsp;'));
      },
      ...
      parseCssText: function (a, e, b) {
        ...
        a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, b, g) {
          e &&
            ((b = b.toLowerCase()),
            'font-family' == b && (g = g.replace(/\s*,\s*/g, ',')),
      ...
      getCookie: function (a) {
        ...
        for (var e = document.cookie.split(';'), b, c, g = 0; g < e.length; g++)
          if (((b = e[g].split('\x3d')), (c = decodeURIComponent(CKEDITOR.tools.trim(b[0]).toLowerCase())), c === a))
            return decodeURIComponent(1 < b.length ? b[1] : '');
        return null;
      },
      ...
      convertBytesToBase64: function (a) {
        ...
        for (g = 0; g < c; g += 3) {
          ...
          for (p = 0; 4 > p; p++)
            b =
              p <= m ? b + 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(f[p]) : b + '\x3d';
        }
        return b;
      },
      style: {
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getIndex: function (a) {
      ...
      do
        (a && c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (h || b(c))) ||
          (f++, (h = c.nodeType == CKEDITOR.NODE_TEXT));
  ...
  CKEDITOR.dom.element.get = function (a) {
    return (
      (a = 'string' == typeof a ? document.getElementById(a) || document.getElementsByName(a)[0] : a) &&
      (a.$ ? a : new CKEDITOR.dom.element(a))
    );
  };
  ...
  CKEDITOR.dom.element.setMarker = function (a, d, b, c) {
    var f =
        ...
        d.setCustomData('list_marker_id', CKEDITOR.tools.getNextNumber()).getCustomData('list_marker_id'),
      h =
  ...
  (function () {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      removeClass: f
        ...
        : function (b) {
            ...
            c &&
              a(c, b) &&
              ((c = c.replace(new RegExp('(?:^|\\s+)' + b + '(?\x3d\\s|$)'), '').replace(/^\s+/, ''))
      ...
      getTabIndex: function () {
        var a = this.$.tabIndex;
        return 0 !== a || CKEDITOR.dtd.$tabIndex[this.getName()] || 0 === parseInt(this.getAttribute('tabindex'), 10)
          ? a
          : -1;
      },
      getText: function () {
      ...
      isEditable: function (a) {
        ...
        return this.isReadOnly() ||
          ...
          (this.is('a') && (this.data('cke-saved-name') || this.hasAttribute('name')) && !this.getChildCount())
          ? !1
          : !1 !== a
      ...
      isEmptyInlineRemoveable: function () {
        ...
        for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
          ...
          if (e.type != CKEDITOR.NODE_ELEMENT || !e.data('cke-bookmark'))
            if (
              (e.type == CKEDITOR.NODE_ELEMENT && !e.isEmptyInlineRemoveable()) ||
      ...
      removeStyle: function (a) {
        ...
        if (b.removeProperty || ('border' != a && 'margin' != a && 'padding' != a))
          ...
          for (var b = [], d = 0; d < c.length; d++)
            if (e) for (var x = 0; x < e.length; x++) b.push([a, c[d], e[x]].join('-'));
      ...
      setOpacity: function (a) {
        CKEDITOR.env.ie && 9 > CKEDITOR.env.version
          ? ((a = Math.round(100 * a)),
            this.setStyle('filter', 100 <= a ? '' : 'progid:DXImageTransform.Microsoft.Alpha(opacity\x3d' + a + ')'))
      ...
      getDocumentPosition: function (a) {
        ...
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
          ...
          k &&
            (CKEDITOR.env.webkit || (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ? ((b = d.$.scrollLeft || h.scrollLeft), (c = d.$.scrollTop || h.scrollTop))
              : ((c = x ? d.$ : h), (b = c.scrollLeft), (c = c.scrollTop)),
            (b = f.left + b - p),
            (c = f.top + c - w));
        } else
          for (w = this, p = null; w && 'body' != w.getName() && 'html' != w.getName(); ) {
        ...
        a &&
          ...
          !f.equals(w) &&
            f.$.frameElement &&
            ((a = new CKEDITOR.dom.element(f.$.frameElement).getDocumentPosition(a)), (b += a.x), (c += a.y)));
      ...
      copyAttributes: function (a, b) {
        ...
        for (var e = 0; e < c.length; e++) {
          ...
          if (!(x in b))
            ...
            else if (!CKEDITOR.env.ie || this.hasAttribute(x))
              (f = this.getAttribute(x)), null === f && (f = d.nodeValue), a.setAttribute(x, f);
        }
      ...
      getEditor: function (a) {
        ...
        for (c in b)
          if (
            ((e = b[c]),
            (e.element.equals(this) && e.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) ||
              (!a && (d = e.editable()) && (d.equals(this) || d.contains(this))))
          )
            return e;
        return null;
      },
    ...
    CKEDITOR.dom.element.prototype.setSize = function (a, b, d) {
      'number' == typeof b &&
        (!d || (CKEDITOR.env.ie && CKEDITOR.env.quirks) || (b -= c.call(this, a)), this.setStyle(a, b + 'px'));
    };
    CKEDITOR.dom.element.prototype.getSize = function (a, b) {
      var d =
        Math.max(this.$['offset' + CKEDITOR.tools.capitalize(a)], this.$['client' + CKEDITOR.tools.capitalize(a)]) || 0;
      b && (d -= c.call(this, a));
      return d;
    };
  })();
  ...
  (function () {
    function a(a, b) {
      ...
      if (!a && !this._.guardLTR) {
        ...
        this._.guardLTR = function (a, b) {
          return (
            (!b || !g.equals(a)) && (!k || !a.equals(k)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
          );
        };
      }
      if (a && !this._.guardRTL) {
        ...
        this._.guardRTL = function (a, b) {
          return (
            (!b || !M.equals(a)) && (!t || !a.equals(t)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
          );
        };
      }
      ...
      h = l
        ...
        : C;
      this.current
        ? (e = this.current[F](!1, q, h))
        : (a
            ? e.type == CKEDITOR.NODE_ELEMENT &&
              (e = 0 < y ? e.getChild(y - 1) : !1 === h(e, !0) ? null : e.getPreviousSourceNode(!0, q, h))
            : ((e = d),
              e.type == CKEDITOR.NODE_ELEMENT &&
                ((e = e.getChild(f)) || (e = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, q, h)))),
          e && !1 === h(e) && (e = null));
      for (; e && !this._.end; ) {
        this.current = e;
    ...
    var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
      ...
      m = function (a) {
        return (
          k(a) || h(a) || (a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty))
        );
      };
          ...
          : b.type == CKEDITOR.NODE_TEXT ||
            (b.type == CKEDITOR.NODE_ELEMENT &&
              (b.is(CKEDITOR.dtd.$inline) ||
                ...
                (!CKEDITOR.env.needsBrFiller && b.is(y) && e(b))))
          ? !0
          : !1;
        return !!(a ^ b);
      };
  ...
  (function () {
    ...
    function d(a, b, c, d, f) {
      ...
      if (
        ...
        (q.equals(F) || (q.type === CKEDITOR.NODE_ELEMENT && q.getFirst().equals(F)))
      )
        c.append(a.document.createText(F.substring(L, E)));
      else {
        F.type == CKEDITOR.NODE_TEXT
          ? l
            ? (P = !0)
        ...
        for (
          ...
          V = X.getNext();
          for (
            Q != v || (X.equals(n[Q]) && v < A)
              ? b && (I = G.append(X.clone(0, f)))
              : M
              ? h(X, G, !1, C)
              : H && G.append(a.document.createText(X.substring(L)));
            V;
        ...
        for (Q = N; Q <= A; Q++)
          if (((c = n[Q]), (V = c.getPrevious()), c.equals(O[Q]))) b && (G = G.getChild(0));
            ...
            Q != A || (c.equals(O[Q]) && A < v)
              ? b && (I = G.append(c.clone(0, f)))
              : t
              ? h(c, G, !1, z)
              : P && G.append(a.document.createText(c.substring(0, E)));
    ...
    function b() {
      ...
      return function (f) {
        return c(f) || b(f)
          ...
          : d(f) && !a
          ? (a = !0)
          : (f.type == CKEDITOR.NODE_TEXT && (f.hasAscendant('pre') || CKEDITOR.tools.trim(f.getText()).length)) ||
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark2: (function () {
        function a(b) {
          ...
          var f = d;
          p =
            p.type != CKEDITOR.NODE_ELEMENT || 0 === f || f == p.getChildCount()
              ? 0
              : p.getChild(f - 1).type == CKEDITOR.NODE_TEXT && p.getChild(f).type == CKEDITOR.NODE_TEXT;
          ...
          if (e.type == CKEDITOR.NODE_TEXT) {
            p = e;
            for (f = 0; (p = p.getPrevious()) && p.type == CKEDITOR.NODE_TEXT; )
              f += p.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, '').length;
            p = f;
            e.getText()
              ? (d += p)
              : ((f = e.getPrevious(c)),
                p
                  ? ((d = p), (e = f ? f.getNext() : e.getParent().getFirst()))
        ...
        return function (c) {
          ...
          c && (a(f), b(f, this.root), d || (a(p), b(p, this.root)));
          return {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            E.type == CKEDITOR.NODE_TEXT
              ? (t && ((E = !CKEDITOR.tools.trim(E.substring(0, t)).length && E), (L = !!E)),
                E && ((q = E.getPrevious()) || (l = E.getParent())))
              : (t && (q = E.getChild(t - 1) || E.getLast()), q || (l = E));
            for (l = c(l); l || q; ) {
              if (l && !q) {
                !F && l.equals(p) && (F = !0);
              ...
              for (; q; )
                if (((E = !1), q.type == CKEDITOR.NODE_COMMENT)) q = q.getPrevious();
                  ...
                  if (q.type == CKEDITOR.NODE_TEXT)
                    (M = q.getText()), d.test(M) && (q = null), (E = /[\s\ufeff]$/.test(M));
                  else if (
                    (q.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || (b && q.is('br'))) &&
                    !q.data('cke-bookmark')
                  )
            ...
            F = L = !1;
            E.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim(E.substring(t)).length
                ? (L = !0)
                : ((L = !E.getLength()),
                  t == E.getLength() ? (q = E.getNext()) || (l = E.getParent()) : h(E, t) && (l = E.getParent()))
              : (q = E.getChild(t)) || (l = E);
            for (; l || q; ) {
              if (l && !q) {
                !F && l.equals(p) && (F = !0);
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            this.setStartAt(
              H,
              !H.is('br') && ((!l && this.checkStartOfBlock()) || (l && H.contains(l)))
            ...
            this.setEndAt(
              H,
              (!l && this.checkEndOfBlock()) || (l && H.contains(l))
      ...
      shrink: function (a, b, c) {
        ...
        if (!this.collapsed) {
          ...
          p &&
            ...
            (k ? (k >= p.getLength() ? h.setStartAfter(p) : (h.setStartBefore(p), (c = 0))) : h.setStartBefore(p));
          g &&
            g.type == CKEDITOR.NODE_TEXT &&
            (r ? (r >= g.getLength() ? h.setEndAfter(g) : (h.setEndAfter(g), (l = 0))) : h.setEndBefore(g));
          ...
          c &&
            (p = h[a == CKEDITOR.SHRINK_ELEMENT ? 'lastForward' : 'next']()) &&
            this.setStartAt(p, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
          l &&
            (h.reset(),
            (h = h[a == CKEDITOR.SHRINK_ELEMENT ? 'lastBackward' : 'previous']()) &&
              this.setEndAt(h, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
          return !(!c && !l);
        }
      },
      ...
      splitBlock: function (a, b) {
        ...
        'br' != a &&
          (f || ((f = this.fixBlock(!0, a)), (h = new CKEDITOR.dom.elementPath(this.endContainer, this.root).block)),
        ...
        f &&
          f.equals(h) &&
          (d
            ? ((p = new CKEDITOR.dom.elementPath(this.startContainer, this.root)),
      ...
      removeEmptyBlocksAtEnd: (function () {
        ...
        return function (b) {
          for (
            var c = this.createBookmark(), d = this[b ? 'endPath' : 'startPath'](), f = d.block || d.blockLimit, h;
      ...
      checkStartOfBlock: function () {
        ...
        CKEDITOR.env.ie &&
          ...
          ((a = CKEDITOR.tools.ltrim(a.substring(0, c))), g.test(a) && this.trim(0, 1));
        this.trim();
      ...
      checkEndOfBlock: function () {
        ...
        CKEDITOR.env.ie &&
          a.type == CKEDITOR.NODE_TEXT &&
          ((a = CKEDITOR.tools.rtrim(a.substring(c))), g.test(a) && this.trim(1, 0));
        this.trim();
      ...
      moveToElementEditablePosition: function (a, b) {
        ...
        for (var c = 0; a; ) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            b && this.endContainer && this.checkEndOfBlock() && g.test(a.getText())
      ...
      moveToClosestEditablePosition: function (a, b) {
        ...
        else if ((f = c[b ? 'getNextEditableNode' : 'getPreviousEditableNode']()))
          (d = 1),
            (h = f.type == CKEDITOR.NODE_ELEMENT) &&
            f.is(CKEDITOR.dtd.$block) &&
            'false' == f.getAttribute('contenteditable')
              ? (c.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), c.setEndAt(f, CKEDITOR.POSITION_AFTER_END))
              : !CKEDITOR.env.needsBrFiller && h && f.is(CKEDITOR.dom.walker.validEmptyBlockContainers)
              ? (c.setEnd(f, 0), c.collapse())
              : c.moveToPosition(f, p[b ? 1 : 0]);
      ...
      _getTableElement: function (a) {
        ...
        return CKEDITOR.env.safari && d && c.equals(this.root)
          ...
          : d && f && (d.equals(f) || d.contains(f) || f.contains(d))
          ? b.getAscendant(a, !0)
          : null;
      },
      ...
      _find: function (a, b) {
        ...
        if (c && c.find)
          for (p = c.find(a), h = 0; h < p.count(); h++)
            if (((c = p.getItem(h)), b || !c.isReadOnly()))
              (g = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c)),
                (k =
                  c.getPosition(d.endNode) & (CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED) ||
                  d.endNode.equals(c)),
                g && k && f.push(c);
        return f;
      },
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          w.collapsed ||
            ((k = new CKEDITOR.dom.walker(w.clone())),
            ...
            (k.evaluator = p),
            (k = k.previous()),
            (this._.lastNode = k.getNextSourceNode(!0, null, w.root)),
            this._.lastNode &&
              ...
              p.checkEndOfBlock() &&
                ...
                (this._.lastNode = (p.block || p.blockLimit).getNextSourceNode(!0)))),
            (this._.lastNode && w.root.contains(this._.lastNode)) ||
              ((this._.lastNode = this._.docEndMarker = w.document.createText('')), this._.lastNode.insertAfter(k)),
            (w = null));
          this._.started = 1;
          k = w;
        }
        ...
        if (!d) {
          ...
          !p.equals(k.root)
            ...
            ? (k.checkStartOfBlock() && k.checkEndOfBlock()) ||
              ...
              (D = !D.wasEndOfBlock),
              k.insertNode(d))
            : x || (this._.nextNode = d.equals(w) ? null : this._getNextSourceNode(k.getBoundaryNodes().endNode, 1, w));
        }
        B &&
          (B = d.getPrevious()) &&
          B.type == CKEDITOR.NODE_ELEMENT &&
          ('br' == B.getName()
            ? B.remove()
            : B.getLast() && 'br' == B.getLast().$.nodeName.toLowerCase() && B.getLast().remove());
        D &&
          (B = d.getLast()) &&
          B.type == CKEDITOR.NODE_ELEMENT &&
          'br' == B.getName() &&
          (!CKEDITOR.env.needsBrFiller || B.getPrevious(h) || B.getNext(h)) &&
          B.remove();
  ...
  CKEDITOR.command.prototype = {
    enable: function () {
      this.state == CKEDITOR.TRISTATE_DISABLED &&
        this.checkAllowed() &&
        this.setState(
          this.preserveState && 'undefined' != typeof this.previousState ? this.previousState : CKEDITOR.TRISTATE_OFF
        );
    },
    disable: function () {
  ...
  (function () {
    function a(a, b, c, d, f) {
      ...
      for (e in b) {
        ...
        for (p in P) {
          ...
          for (; (H = z.pop()); ) (A[H] = A['!' + H]), delete A['!' + H];
          h[q] = (g ? !1 : t) || null;
        }
      ...
      for (d = a.length; c < d; ++c) {
        ...
        if (!0 === e.elements || null === e.elements) f[v ? 'unshift' : 'push'](e);
        else
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var e = 0, v = c.length, l; e < v; ++e) (l = c[e]), f[l] || (f[l] = a(l));
                a = !1;
              }
            else a = !1;
            d.allClasses = a;
    ...
    function e(a) {
      var b,
        ...
        e = {},
        v = 1;
      for (a = z(a); (b = a.match(n)); )
        (c = b[2]) ? ((d = y(c, 'styles')), (f = y(c, 'attrs')), (c = y(c, 'classes'))) : (d = f = c = null),
          (e['$' + v++] = { elements: b[1], classes: c, styles: d, attributes: f }),
      ...
      if (e.doFilter) {
        ...
        if (!a.allAttributes)
          for (G in h)
            g[G] ||
              (O.test(G)
                ? G == (N = G.replace(/^data-cke-saved-/, '')) || g[N] || (delete h[G], (k = !0))
                : (delete h[G], (k = !0)));
    ...
    function l(a, b, c) {
      ...
      if (t.$empty[d] || !a.children.length)
        'hr' == d && 'br' == b ? a.replaceWith(u()) : (a.parent && c.push({ check: 'it', el: a.parent }), a.remove());
      else if (t.$block[d] || 'tr' == d)
        if ('br' == b)
          a.previous && !K(a.previous) && ((b = u()), b.insertBefore(a)),
            a.next && !K(a.next) && ((b = u()), b.insertAfter(a)),
          ...
          if (f) (a.name = b), (a.attributes = {}), c.push({ check: 'parent-down', el: a });
            ...
            f = a.parent;
            for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || 'body' == f.name, n, h, v = d.length; 0 < v; )
              (l = d[--v]),
                e && (l.type == CKEDITOR.NODE_TEXT || (l.type == CKEDITOR.NODE_ELEMENT && t.$inline[l.name]))
                  ? (n ||
                      ((n = new CKEDITOR.htmlParser.element(b)),
                      n.insertAfter(a),
                      c.push({ check: 'parent-down', el: n })),
                    n.add(l, 0))
                  : ((n = null),
                    (h = t[f.name] || t.span),
                    l.insertAfter(a),
    ...
    function F(a, b) {
      ...
      for (v in f) if (a.styles[v] != f[v]) return !1;
      return !0;
    }
    function L(a, b) {
      var c, d;
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function (a, b, c, d) {
        ...
        for (; (C = a.pop()); )
          if (((c = C.el), c.parent))
            switch (((z = t[c.parent.name] || t.span), C.check)) {
              case 'it':
                t.$removeEmpty[c.name] && !c.children.length ? l(c, d, a) : p(c) || l(c, d, a);
                break;
              case 'el-up':
                c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || z[c.name] || l(c, d, a);
                break;
              case 'parent-down':
        ...
        if (!this.disabled && a) {
          ...
          for (f = 0; f < a.length; ++f) {
            ...
            for (v = 0; v < b.length; ++v)
              (l = b[v]),
                'string' == typeof l
                  ? ((l = l.split(/\s*:\s*/)), (n = l[0]), (h = null), (p = l[1]))
                  : ((n = l.check), (h = l.left), (p = l.right)),
                e ||
                  ((e = l),
                  (e = e.element ? e.element : n ? n.match(/^([a-z0-9]+)/i)[0] : e.left.getDefinition().element)),
                h instanceof CKEDITOR.style && (h = E(h)),
                c.push({ check: n == e ? null : n, left: h, right: 'string' == typeof p ? M(p) : p });
            b = e;
            d[b] || (d[b] = []);
            d[b].push(c);
          }
      ...
      check: function (a, b, c) {
        ...
        if ('string' == typeof a) {
          ...
          (d = a.getDefinition()),
            (f = d.styles),
            (l = d.attributes || {}),
            f && !CKEDITOR.tools.isEmpty(f) ? ((f = C(f)), (l.style = CKEDITOR.tools.writeCssText(f, !0))) : (f = {}),
            (f = {
              name: d.element,
              attributes: l,
    ...
    G = CKEDITOR.filter.transformationsTools = {
      ...
      transform: function (a, b) {
        if ('string' == typeof b) a.name = b;
          ...
          for (e in f)
            if ('class' == e)
              for (c = a.classes.join('|'), v = f[e].split(/\s+/); (n = v.pop()); )
                -1 == c.indexOf(n) && a.classes.push(n);
                    ...
                    (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat)
                      ? (e.$.onreadystatechange = function () {
                          if ('loaded' == e.$.readyState || 'complete' == e.$.readyState)
                            (e.$.onreadystatechange = null), x(b, !0);
                        })
                      : ((e.$.onload = function () {
                          setTimeout(function () {
                            x(b, !0);
          ...
          a.call(
            ...
            function (a) {
              ...
              for (e in a) {
                ...
                if (!d[e]) {
                  if (g.icons)
                    for (var B = g.icons.split(','), D = B.length; D--; )
                      CKEDITOR.skin.addIcon(
                        B[D],
                        g.path + 'icons/' + (CKEDITOR.env.hidpi && g.hidpi ? 'hidpi/' : '') + B[D] + '.png'
                      );
                  d[e] = 1;
                }
              ...
              if (b.length) k.call(this, b);
                ...
                for (e in h)
                  (g = h[e]),
                    g.onLoad && !g.onLoad._called && (!1 === g.onLoad() && delete h[e], (g.onLoad._called = 1));
                c && c.call(f || window, h);
              }
            },
            this
  ...
  (function () {
    ...
    function k(a) {
      ...
      c.fn
        ? (c.fn.call(a, a.config),
          (CKEDITOR.getUrl(a.config.customConfig) != b && k(a)) || a.fireOnce('customConfigLoaded'))
    ...
    function y(a) {
      var b = a.config,
        ...
        f = b.removePlugins;
      if (d)
        var e = new RegExp('(?:^|,)(?:' + d.replace(/\s*,\s*/g, '|') + ')(?\x3d,|$)', 'g'),
          c = c.replace(e, ''),
          c = c + (',' + d);
      if (f)
        var h = new RegExp('(?:^|,)(?:' + f.replace(/\s*,\s*/g, '|') + ')(?\x3d,|$)', 'g'),
          c = c.replace(h, '');
      ...
      CKEDITOR.plugins.load(c.split(','), function (c) {
        ...
        for (var l in c) {
          ...
          if (O && (n = O.match(h)))
            for (; (O = n.pop()); )
              CKEDITOR.error('editor-plugin-required', { plugin: O.replace(',', ''), requiredBy: l });
          k &&
            !a.lang[l] &&
            (k.split && (k = k.split(',')),
            0 <= CKEDITOR.tools.indexOf(k, a.langCode)
              ...
              : ((g = a.langCode.replace(/-.*/, '')),
                (g =
                  g != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, g)
                    ? g
                    : 0 <= CKEDITOR.tools.indexOf(k, 'en')
                    ? 'en'
                    : k[0])),
            q.langEntries && q.langEntries[g]
              ? ((a.lang[l] = q.langEntries[g]), (g = null))
              : e.push(CKEDITOR.getUrl(q.path + 'lang/' + g + '.js')));
          f.push(g);
          d.push(q);
        }
    ...
    function B(a, b) {
      ...
      for (var f = new CKEDITOR.dom.documentFragment(), e, h, g, k = 0; k < a.length; k++) {
        ...
        c(M)
          ? (e ||
              ((e = t.getAscendant('table').clone()),
              e.append(t.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()),
              f.append(e),
              (e = e.findOne('thead, tbody, tfoot'))),
            (h && h.equals(t)) || ((h = t), (g = t.clone()), e.append(g)),
            g.append(d(M)))
          : f.append(M.cloneContents());
      }
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      ...
      execCommand: function (a, b) {
        ...
        return c &&
          ...
          ((d.returnValue = c.exec(d.commandData)), !c.async && !1 !== this.fire('afterCommandExec', d))
          ? d.returnValue
          : !1;
      },
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (h, k, g) {
      function m(a) {
        ...
        if (0 < p.length)
          for (var c = 0; c < p.length; c++) {
            ...
            (l && !l[f]) || (a && e && !e[a] && CKEDITOR.dtd[a])
              ? f == u.name && (y(u, u.parent, 1), c--)
              : (b || (r(), (b = 1)), (d = d.clone()), (d.parent = u), (u = d), p.splice(c, 1), c--);
          }
      }
      function r() {
      ...
      function y(b, c, d) {
        ...
        var f = u;
        void 0 === b.previous &&
          (x(c, b) && ((u = c), D.onTagOpen(g, {}), (b.returnPoint = c = u)),
          e(b),
      ...
      D.onTagOpen = function (f, e, h, g) {
        ...
        if (a(e)) p.push(e);
          ...
          if ('br' == f) J.push(e);
            ...
            for (
              ;
              !((g = (h = u.name) ? CKEDITOR.dtd[h] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c),
              e.isUnknown || u.isUnknown || g[f]);

            )
              if (u.isOptionalClose) D.onTagClose(h);
              else if (f in b && h in b)
                (h = u.children),
                  ((h = h[h.length - 1]) && 'li' == h.name) || y((h = new CKEDITOR.htmlParser.element('li')), u),
                  !e.returnPoint && (e.returnPoint = u),
                  (u = h);
              else if (f in CKEDITOR.dtd.$listItem && !B(f, h)) D.onTagOpen('li' == f ? 'ul' : 'dl', {}, 0, 1);
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        onElement: function (a, c) {
          for (
            var d = [this.elementsRules['^'], this.elementsRules[c.name], this.elementsRules.$], h, k = 0;
            3 > k;
            k++
          )
            if ((h = d[k])) {
      ...
      exec: function (a, c) {
        ...
        for (y = 0; y < g; y++)
          if (
            (d && ((m = c.type), (r = c.name)),
            (e = k[y]),
            !((a.nonEditable && !e.options.applyToAll) || (a.nestedEditable && e.options.excludeNestedEditable)))
          ) {
  ...
  (function () {
    function a(a, d) {
        ...
        return function (f) {
          if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var l = [],
              ...
              C;
            if (v)
              for (t(v, 1) && l.push(v); v; )
                h(v) && (n = c(v)) && t(n) && ((C = c(n)) && !h(C) ? l.push(n) : (e(z).insertAfter(n), n.remove())),
                  (v = v.previous);
            for (v = 0; v < l.length; v++) l[v].remove();
            if ((l = !a || !1 !== ('function' == typeof d ? d(f) : d)))
              z || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                ? z ||
                  CKEDITOR.env.needsBrFiller ||
                  !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem)
                  ? ((l = b(f)), (l = !l || ('form' == f.name && 'input' == l.name)))
                  : (l = !1)
                : (l = !1);
            l && f.add(e(a));
          }
      ...
      function t(a, b) {
        ...
        return a.type == CKEDITOR.NODE_TEXT &&
          (c = a.value.match(p)) &&
          (c.index && (new CKEDITOR.htmlParser.text(a.value.substring(0, c.index)).insertBefore(a), (a.value = c[0])),
          (!CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in g)) ||
            (!z && (((c = a.previous) && 'br' == c.name) || !c || h(c))))
          ? !0
          : !1;
      }
      var C = { elements: {} },
    ...
    function r(a) {
      return a.replace(M, function (a, b, c) {
        return (
          '\x3c' +
          b +
          c.replace(t, function (a, b) {
            return C.test(b) && -1 == c.indexOf('data-cke-saved-' + b)
    ...
    function e(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf('\x3ctextarea') &&
          (a = b + B(c).replace(/</g, '\x26lt;').replace(/>/g, '\x26gt;') + '\x3c/textarea\x3e');
    ...
    function w(a, b) {
      ...
      a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (
        a
      ) {
      ...
      b.on(
        ...
        function (a) {
          ...
          CKEDITOR.env.ie &&
            9 > CKEDITOR.env.version &&
            'pre' == f &&
            ((f = 'div'), (c = '\x3cpre\x3e' + c + '\x3c/pre\x3e'), (l = 1));
          ...
          f &&
            ((l = c),
            !l.children.length && CKEDITOR.dtd[l.name][f] && ((f = new CKEDITOR.htmlParser.element(f)), l.add(f)));
          a.dataValue = c;
        },
        null,
        null,
        ...
        for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, h = c.count(); f < h; f++)
          (a = c.getItem(f)),
            'true' == a.getAttribute('contenteditable') &&
              ((d = { element: a, config: {} }), !1 !== CKEDITOR.fire('inline', d) && CKEDITOR.inline(a, d.config));
    };
    CKEDITOR.domReady(function () {
  ...
  (function () {
    function a(a) {
      ...
      k(b, e.block, f) &&
        g.collapsed &&
        !g.getCommonAncestor().isReadOnly() &&
        ((e = g.clone()),
      ...
      if (e.startPath().contains(f)) {
        ...
        if (d)
          return (
            (h = e.clone()),
            h.collapse(),
            h.setEndAt(d, CKEDITOR.POSITION_AFTER_END),
            (a = new CKEDITOR.dom.walker(h)),
            (a.guard = b(!0)),
            (d = !1),
            a.checkForward(),
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      ...
      proto: {
        focus: function () {
          ...
          CKEDITOR.env.safari &&
            !this.isInline() &&
            ((a = CKEDITOR.document.getActive()), a.equals(this.getWindow().getFrame()) || this.getWindow().focus());
        },
        on: function (a, b) {
          ...
          this.insertElementIntoRange(a, b) &&
            ...
            f &&
              ...
              f.is(CKEDITOR.dtd.$block)
                ...
                : f ||
                  e == CKEDITOR.ENTER_BR ||
                  ((f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? 'div' : 'p')), b.moveToElementEditStart(f))));
          d.selectRanges([b]);
          m(this);
        },
        ...
        insertElementIntoRange: function (a, b) {
          ...
          var t, C;
          if (f)
            for (; (t = b.getCommonAncestor(0, 1)) && (C = CKEDITOR.dtd[t.getName()]) && (!C || !C[e]); )
              t.getName() in CKEDITOR.dtd.span
                ? b.splitElement(t)
                : b.checkStartOfBlock() && b.checkEndOfBlock()
                ? (b.setStartBefore(t), b.collapse(!0), t.remove())
        ...
        extractHtmlFromRange: function (a, b) {
          ...
          d.tableContentsRanges
            ...
            : (a.moveToBookmark(d.bookmark), (d.range = a), a.extractContents(c.detectExtractMerge(d)));
        ...
        setup: function () {
          ...
          a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE
            ...
            : (a.elementMode != CKEDITOR.ELEMENT_MODE_REPLACE && a.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) ||
          ...
          if (!this.is('textarea')) {
            ...
            if (k) {
              ...
              p
                ? k != p.getText() &&
                  (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? (p.$.styleSheet.cssText = k) : p.setText(k))
              ...
              if (0 !== b.getRanges().length) {
                if (c in t) {
                  var f,
                    ...
                    A,
                    c = 8 == c;
                  (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (f = b.getSelectedElement())) || (f = h(b))
                    ? (a.fire('saveSnapshot'),
                    ...
                    : g.collapsed &&
                      ((k = n.block) &&
                      (A = k[c ? 'getPrevious' : 'getNext'](e)) &&
                      A.type == CKEDITOR.NODE_ELEMENT &&
                      A.is('table') &&
                      g[c ? 'checkStartOfBlock' : 'checkEndOfBlock']()
                        ? (a.fire('saveSnapshot'),
                          g[c ? 'checkEndOfBlock' : 'checkStartOfBlock']() && k.remove(),
                          g['moveToElementEdit' + (c ? 'End' : 'Start')](A),
                          g.select(),
                          a.fire('saveSnapshot'),
                          (d = 1))
                        : n.blockLimit &&
                          n.blockLimit.is('td') &&
                          (v = n.blockLimit.getAscendant('table')) &&
                          g.checkBoundaryOfElement(v, c ? CKEDITOR.START : CKEDITOR.END) &&
                          (A = v[c ? 'getPrevious' : 'getNext'](e))
                        ? (a.fire('saveSnapshot'),
                          g['moveToElementEdit' + (c ? 'End' : 'Start')](A),
                          g.checkStartOfBlock() && g.checkEndOfBlock() ? A.remove() : g.select(),
                          a.fire('saveSnapshot'),
                          (d = 1))
                        : (v = n.contains(['td', 'th', 'caption'])) &&
                          g.checkBoundaryOfElement(v, c ? CKEDITOR.START : CKEDITOR.END) &&
                          (d = 1));
                }
                return !d;
            ...
            (CKEDITOR.env.ie && !CKEDITOR.env.edge) ||
              this.attachListener(this, 'mousedown', function (b) {
                ...
                c.is('img', 'hr', 'input', 'textarea', 'select') &&
                  !c.isReadOnly() &&
                  (a.getSelection().selectElement(c), c.is('input', 'textarea', 'select') && b.data.preventDefault());
              });
            CKEDITOR.env.edge &&
                      ...
                      (c = d),
                        ...
                        n && d && !n.equals(d)
                          ? (a.fire('saveSnapshot'),
                            ...
                            c.deleteContents(),
                            d.getParent() && (d.moveChildren(n, !1), b.lastElement.mergeSiblings(), r(n, d, !0)),
    ...
    CKEDITOR.on('instanceLoaded', function (b) {
      ...
      c.on('selectionChange', function (b) {
        if (!c.readOnly) {
          ...
          d &&
            !d.isLocked &&
            ((d = c.checkDirty()), c.fire('lockSnapshot'), a(b), c.fire('unlockSnapshot'), !d && c.resetDirty());
        }
      });
    });
    ...
    w = (function () {
      ...
      function b(c, d) {
        ...
        for (
          ...
          (e = H.getItem(z)),
            a(e)
              ? ((t = e.getName()),
                E && t in CKEDITOR.dtd.$list
                  ? (h = h.concat(b(e, d)))
                  : ((g = !!k[t]),
                    'br' != t ||
                      !e.data('cke-eol') ||
                      (z && z != p - 1) ||
                      ((P = (f = z ? h[z - 1].node : H.getItem(z + 1)) && (!a(f) || !f.is('br'))),
      ...
      function h(b, c, d, e) {
        ...
        (t = new CKEDITOR.dom.walker(f).next()) &&
          a(t) &&
          z[t.getName()] &&
          (g = t.getPrevious()) &&
          a(g) &&
          !g.getParent().equals(b.startContainer) &&
          d.contains(g) &&
          e.contains(t) &&
          t.isIdentical(g) &&
      ...
      var C = CKEDITOR.dtd,
        ...
        p = CKEDITOR.tools.extend({}, C.$inline);
      delete p.br;
      return function (z, n, N, v) {
        ...
        if (!v.checkReadOnly()) {
          ...
          var m, r;
          'text' == z.type &&
            n.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) &&
            ((m = CKEDITOR.dom.element.createFromHtml('\x3cspan\x3e\x26nbsp;\x3c/span\x3e', n.document)),
            n.insertNode(m),
            n.setStartAfter(m));
          ...
          for (; (r = e(n)) && a(r) && r.isBlockBoundary() && G.contains(r); )
            n.moveToPosition(r, CKEDITOR.POSITION_BEFORE_END);
          h(n, z.blockLimit, G, I);
          m && (n.setEndBefore(m), n.collapse(), m.remove());
          m = n.startPath();
          if ((A = m.contains(f, !1, 1)))
            n.splitElement(A), (z.inlineStylesRoot = A), (z.inlineStylesPeak = m.lastElement);
          m = n.createBookmark();
          ...
          if ((m = N)) {
            ...
            if ((w = m.startPath().block) && (1 != w.getChildCount() || !w.getBogus()))
              a: {
                var y;
          ...
          if (m) {
            ...
            var G = z.endPath.elements[0],
              ...
              I = G.getPosition(n),
              x =
                !!G.getCommonAncestor(n) &&
                I != CKEDITOR.POSITION_IDENTICAL &&
                !(I & (CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED));
            n = b(z.dataWrapper, z);
            for (t(n, y); v < n.length; v++) {
              ...
              if ((u = I.isLineBreak)) {
                ...
                I.hasBlockSibling
                  ? (u = 1)
                  : (S = u.startContainer.getAscendant(C.$block, 1)) && S.is({ div: 1, p: 1 })
                  ? ((Y = S.getPosition(J)),
                    Y == CKEDITOR.POSITION_IDENTICAL || Y == CKEDITOR.POSITION_CONTAINS
                      ? (u = 0)
                      : ((J = u.splitElement(S)), u.moveToPosition(J, CKEDITOR.POSITION_AFTER_START), (u = 1)))
                  : (u = 0);
              }
              if (u) N = 0 < v;
              else {
                u = y.startPath();
                !I.isBlock &&
                  k(z.editor, u.block, u.blockLimit) &&
                  (T = g(z.editor)) &&
                  ((T = m.createElement(T)),
                  T.appendBogus(),
                  y.insertNode(T),
                  CKEDITOR.env.needsBrFiller && (B = T.getBogus()) && B.remove(),
                  y.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
                ...
                if (A && I.isElement) {
                  ...
                  if (u) J && ((K = y.splitElement(J)), z.zombies.push(K), z.zombies.push(J));
                    ...
                    u = v == n.length - 1;
                    J = d(I.node, J);
                    for (var S = [], Y = J.length, Z = 0, ba = void 0, ca = 0, U = -1; Z < Y; Z++)
                      (ba = J[Z]),
                        ' ' == ba
                          ? (ca || (W && !Z) || (S.push(new CKEDITOR.dom.text(' ')), (U = S.length)), (ca = 1))
                          : (S.push(ba), (ca = 0));
                    u && U == S.length && S.pop();
                    W = S;
                  }
                ...
                I.lastNotAllowed &&
                  v < n.length - 1 &&
                  ((K = x ? G : K) && y.setEndAt(K, CKEDITOR.POSITION_AFTER_START), (A = 0));
                y.collapse();
              }
            }
            1 != n.length
              ? (B = !1)
              : ((B = n[0]), (B = B.isElement && 'false' == B.node.getAttribute('contenteditable')));
            B &&
              ((N = !0),
              (u = n[0].node),
          ...
          for (W = B.createBookmark(); (D = z.zombies.pop()); )
            D.getParent() && ((T = B.clone()), T.moveToElementEditStart(D), T.removeEmptyBlocksAtEnd());
          if (K)
    ...
    p = (function () {
      ...
      return function (d) {
        ...
        f.is('table')
          ...
          : (f.is({ tbody: 1, thead: 1, tfoot: 1 }) && (f = b(f, 'tr', t)),
            f.is('tr') && (f = b(f, f.getParent().is('thead') ? 'th' : 'td', t)),
            (e = f.getBogus()) && e.remove(),
            d.moveToPosition(f, t ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END));
      };
    })();
    J = (function () {
      function a(b) {
    ...
    u = {
      eol: {
        detect: function (a, b) {
          ...
          t.block &&
            e.checkBoundaryOfElement(t.block, CKEDITOR.START) &&
            (c.setEndBefore(t.block), (a.appendEolBr = 1));
        },
        fix: function (a, b) {
          var c = b.getDocument(),
            d;
      ...
      tree: {
        rebuild: function (a, b) {
          ...
          if (e.blockLimit.is({ tr: 1, table: 1 })) {
            ...
            ((f = f.contains(CKEDITOR.dtd.$list)), (c = c.contains(CKEDITOR.dtd.$list)), !f.equals(c))
          ) {
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            ...
            a.mergeListItems =
              e.block && f.block && e.block.is(CKEDITOR.dtd.$listItem) && f.block.is(CKEDITOR.dtd.$listItem);
          ...
          function a(c) {
            ...
            g.guard = function (a, g) {
              ...
              if (g && h && a.equals(h)) (f = c.clone()), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f);
                ...
                (f = c.clone()), f.setStartAt(k, CKEDITOR.POSITION_AFTER_START), e.push(f);
              else {
                if ((A = !g)) A = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k));
                if (!A && (A = g))
                  if (a.is(d))
                    var A = h && h.getAscendant('table', !0),
              ...
              if (n || l)
                n && l && b(n, l)
                  ...
                  ? l ||
                    ((e.tableSurroundingRange = h),
                    h.setStartAt(n, CKEDITOR.POSITION_AFTER_END),
                    g.setEndAt(n, CKEDITOR.POSITION_AFTER_END))
                  : ((e.tableSurroundingRange = h),
                    h.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
        ...
        detectExtractMerge: function (a) {
          return !(
            a.range.startPath().contains(CKEDITOR.dtd.$listItem) && a.range.endPath().contains(CKEDITOR.dtd.$listItem)
          );
        },
  ...
  (function () {
    ...
    function d(b, c) {
      ...
      if ((d = !c && 1 === b.length) && !(d = b[0].collapsed)) {
        ...
        d && d.equals(g) && !d.findOne('td, th, tr, tbody, table')
          ? ((f = f.cloneContents()), (d = f.getFirst() ? e(f.getFirst().getText()) !== e(d.getText()) : !0))
          : (d = !1);
      }
      if (d) return !1;
    ...
    function h() {
      ...
      c.compare(this._.selectionPreviousPath) ||
        ((e = this._.selectionPreviousPath && this._.selectionPreviousPath.blockLimit.equals(c.blockLimit)),
        CKEDITOR.env.webkit && !e && (this._.previousActive = this.document.getActive()),
    ...
    function r(a) {
      ...
      return b(d) || b(e, 1) || !(d || e || (c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() && c.getBogus()))
        ? !0
        : !1;
    }
    function e(a) {
    ...
    function y(a, b) {
      ...
      if (c) {
        ...
        n &&
          ...
          (d = c.getSelection()),
          (c = c.createRange()),
          c.setStart(n[0].node, n[0].offset),
          c.collapse(!0),
          d.removeAllRanges(),
          d.addRange(c),
          d.extend(n[1].node, n[1].offset));
      }
    }
    function x(a, b) {
      return b
        ? a.replace(K, function (a, b) {
            return b ? ' ' : '';
          })
        : a.replace(u, '');
    }
    function B(a, b) {
      var c = CKEDITOR.dom.element.createFromHtml(
        '\x3cdiv data-cke-hidden-sel\x3d"1" data-cke-temp\x3d"1" style\x3d"' +
          (CKEDITOR.env.ie && 14 > CKEDITOR.env.version ? 'display:none' : 'position:fixed;top:0;left:-1000px') +
          '"\x3e' +
          (b || '\x26nbsp;') +
          '\x3c/div\x3e',
        a.document
        ...
        if (!c.collapsed) {
          ...
          d.evaluator = function (d) {
            if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
              ...
              d.getPosition(g.endContainer) & CKEDITOR.POSITION_CONTAINS ||
      ...
      c.on('contentDom', function () {
          ...
          g.attachListener(
            ...
            function (a) {
              ...
              0 !== m &&
                ...
                a.isCollapsed &&
                a.anchorNode == g.$ &&
                ((a = c.createRange()), a.moveToElementEditStart(g), a.select());
            },
            null,
            null,
            -2
        ...
        g.attachListener(
          ...
          function () {
            m &&
              CKEDITOR.env.webkit &&
              (m = c._.previousActive && c._.previousActive.equals(e.getActive())) &&
          ...
          g.attachListener(g, 'mousedown', function (a) {
            2 == a.data.$.button &&
              (((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE) ||
                (x = c.window.getScrollPosition()));
          });
          g.attachListener(g, 'mouseup', function (a) {
            2 == a.data.$.button &&
              x &&
              ((c.document.$.documentElement.scrollLeft = x.x), (c.document.$.documentElement.scrollTop = x.y));
            x = null;
          });
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      if (b)
        return (
          CKEDITOR.tools.extend(this._.cache, b._.cache), (this.isFake = b.isFake), (this.isLocked = b.isLocked), this
        );
      a = this.getNative();
      var d, e;
      if (a)
    ...
    CKEDITOR.dom.selection.prototype = {
      getNative: function () {
        return void 0 !== this._.cache.nativeSel
          ...
          : (this._.cache.nativeSel = p ? this.document.$.selection : this.document.getWindow().$.getSelection());
      },
      getType: p
        ? function () {
            var a = this._.cache;
              ...
              var b = function (b, c) {
                ...
                if (-1 == t || (t == e.length - 1 && 0 > m)) {
                  ...
                  for (d = e.length; 0 < h && 0 < d; )
                    (g = e[--d]), g.nodeType == CKEDITOR.NODE_TEXT && ((p = g), (h -= g.nodeValue.length));
              ...
              return function () {
                ...
                if (d == CKEDITOR.SELECTION_ELEMENT) {
                  for (var d = [], e = 0; e < c.length; e++) {
                    for (
                      var f = c.item(e), g = f.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root);
          ...
          c = CKEDITOR.tools.tryThese(
            ...
            function () {
              for (
                ...
                e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && M[c.getName()] && (d = c));
                e--
              )
      ...
      unlock: function (a) {
        if (this.isLocked) {
          ...
          a &&
            ...
            (d(c) ? f.call(this, c) : e ? this.fake(b) : b ? this.selectElement(b) : this.selectRanges(c));
        }
      },
      reset: function () {
        this._.cache = {};
          ...
          if (this.isLocked) {
            ...
            a: {
              ...
              if (
                ...
                (m = v.getEnclosedNode()) && m.type == CKEDITOR.NODE_ELEMENT && (n = m),
            ...
            if (n) this.fake(n);
              ...
              if (p) {
                ...
                if (
                  (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in v) ||
                  (b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in v)
                )
                ...
                k
                  ...
                  : ((A = v.getNext(m)),
                    (G = v.hasAscendant('pre')),
                    (A =
                      !(A && A.getText && A.getText().match(n)) &&
                      (G || !v.hasPrevious() || (v.getPrevious().is && v.getPrevious().is('br')))),
                    (G = b.document.createElement('span')),
                    G.setHtml('\x26#65279;'),
                    G.insertBefore(v),
                    A && b.document.createText('﻿').insertBefore(v));
                b.setStartBefore(v);
                v.remove();
                a
                  ? (A ? (I.moveStart('character', -1), I.select(), b.document.$.selection.clear()) : I.select(),
                    b.moveToPosition(G, CKEDITOR.POSITION_BEFORE_START),
                    G.remove())
                  : (b.setEndBefore(k), k.remove(), I.select());
              } else {
                k = this.getNative();
                if (!k) return;
                ...
                for (I = 0; I < a.length; I++) {
                  if (
                    ...
                    (G = a[I + 1]),
                    (n = A.clone()),
                    n.setStart(A.endContainer, A.endOffset),
                    n.setEnd(G.startContainer, G.startOffset),
                    !n.collapsed &&
                  ...
                  b.collapsed &&
                    ...
                    ((n = e(this.root)),
                    b.insertNode(n),
                    (A = n.getNext()) && !n.getPrevious() && A.type == CKEDITOR.NODE_ELEMENT && 'br' == A.getName()
                      ? (y(this.root), b.moveToPosition(A, CKEDITOR.POSITION_BEFORE_START))
                  ...
                  try {
                    ...
                    if (0 <= x.toString().indexOf('NS_ERROR_ILLEGAL_VALUE'))
                      b.collapse(1), G.setEnd(b.endContainer.$, b.endOffset);
                    else throw x;
                  }
                  k.addRange(G);
                }
      ...
      selectBookmarks: function (a) {
        ...
        a.isFake &&
          ...
          (c && c.type == CKEDITOR.NODE_ELEMENT) || (CKEDITOR.warn('selection-not-fake'), (a.isFake = 0)));
  ...
  (function () {
        ...
        for (q.getPosition(x) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q; ) {
          ...
          if (q.equals(x)) (q = null), (l = !0);
            ...
            var y = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
              ...
              B = y && q.getAttribute('data-nostyle');
            ...
            if (w && m && CKEDITOR.dtd.$block[y])
              for (
                var E = q, C = f(E), F = void 0, H = C.length, K = 0, E = H && new CKEDITOR.dom.range(E.getDocument());
                K < H;
                ++K
              ) {
                var F = C[K],
            ...
            if (C)
              if (
                ...
                (H = g),
                (K = k),
                !F || (!(F.getDtd() || CKEDITOR.dtd.span)[H] && !K) || (C.parentRule && !C.parentRule(F)))
              )
                l = !0;
              else {
                if (
                  (u ||
                    (y && CKEDITOR.dtd.$removeEmpty[y] && (q.getPosition(x) | P) != P) ||
                    ((u = c.clone()), u.setStartBefore(q)),
                  (y = q.type),
                  y == CKEDITOR.NODE_TEXT || w || (y == CKEDITOR.NODE_ELEMENT && !q.getChildCount()))
                ) {
                  for (var y = q, M; (l = !y.getNext(z)) && ((M = y.getParent()), p[M.getName()]) && d(M, t, h, O); )
                    y = M;
                  u.setEndAfter(y);
                }
              }
            ...
            for (
              ...
              if (B.getName() == g) {
                for (U in h.attributes)
                  !H[U] && (aa = B.getAttribute(R)) && (l.getAttribute(U) == aa ? (C[U] = 1) : (H[U] = 1));
      ...
      function b() {
        for (
          var a = new CKEDITOR.dom.elementPath(d.getParent()),
            c = new CKEDITOR.dom.elementPath(p.getParent()),
            e = null,
            f = null,
            g = 0;
          g < a.elements.length;
      ...
      if (a.collapsed) {
        for (
          ...
          if (this.checkElementRemovable(k)) {
            ...
            !e &&
            a.collapsed &&
            (a.checkBoundaryOfElement(k, CKEDITOR.END) || (m = a.checkBoundaryOfElement(k, CKEDITOR.START)))
              ? ((g = k), (g.match = m ? 'start' : 'end'))
              : (k.mergeSiblings(), k.is(this.element) ? B.call(this, k) : w(k, l(this)[k.getName()]));
          }
        if (g) {
          e = d;
          for (h = 0; ; h++) {
        ...
        for (f = d; !f.equals(p); )
          (g = f.getNextSourceNode()),
            f.type == CKEDITOR.NODE_ELEMENT &&
              ...
              (f.getName() == this.element ? B.call(this, f) : w(f, l(this)[f.getName()]),
    ...
    function y(a, b, c) {
      var d = '',
        e = '';
      a = a.replace(/(^<span[^>]+data-cke-bookmark.*?\/span>)|(<span[^>]+data-cke-bookmark.*?\/span>$)/gi, function (
        a,
        b,
        c
      ) {
    ...
    function B(a, b) {
      var c = this._.definition,
        ...
        g;
      for (g in d)
        if (('class' != g && !this._.definition.fullMatch) || a.getAttribute(g) == q(g, d[g]))
    ...
    function D(a) {
      for (var b = l(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e; )
        (d = c.getItem(e)), d.isReadOnly() || B.call(this, d, !0);
      for (var f in b)
        if (f != this.element)
          for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)
            (d = c.getItem(e)), d.isReadOnly() || w(d, b[f]);
    }
    function w(a, b, c) {
      if ((b = b && b.attributes))
    ...
    CKEDITOR.style = function (a, b) {
      ...
      c &&
        c.style &&
        ((a.styles = CKEDITOR.tools.extend({}, a.styles, CKEDITOR.tools.parseCssText(c.style))), delete c.style);
    ...
    CKEDITOR.dom.elementPath = function (b, f) {
      ...
      do
        if (m.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (
            !this.lastElement &&
            ((this.lastElement = m), m.is(CKEDITOR.dtd.$object) || 'false' == m.getAttribute('contenteditable'))
          )
            continue;
          if (m.equals(f)) break;
          if (
            !k &&
            ((r = m.getName()), 'true' == m.getAttribute('contenteditable') ? (k = m) : !h && d[r] && (h = m), a[r])
          ) {
            if ((r = !h && 'div' == r)) {
              a: {
                r = m.getChildren();
  ...
  (function () {
    function a(a, c, d) {
      ...
      k.equals(m.getPrevious())
        ? ((c.startOffset = c.startOffset - k.getLength() - a.getPrevious().getLength()), (k = a.getNext()))
          ...
          getNextRange: function (k) {
            ...
            if (g && 1 < a.length) {
              ...
              for (g.moveToBookmark(d.shift()); r--; )
                (m = a[++h]), m.moveToBookmark(d.shift()), g.setEnd(m.endContainer, m.endOffset);
            }
            return g;
          },
        };
...
*/
        ...
        CKEDITOR.ui.dialog,
        {
          ...
          radio: function (b, a, d) {
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                for (
                  var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + '_radio', k = 0;
                  k < a.items.length;
                  k++
                ) {
                  var l = a.items[k],
            ...
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                ...
                for (var k = 0, l; k < a.items.length && (l = a.items[k]); k++)
                  d.push(
                    '\x3coption value\x3d"',
                    CKEDITOR.tools.htmlEncode(void 0 !== l[1] ? l[1] : l[0]).replace(/"/g, '\x26quot;'),
                    '" /\x3e ',
            ...
            function b() {
              ...
              d.$.write(
                [
                  ...
                  'window.onbeforeunload \x3d function() {window.parent.CKEDITOR.tools.callFunction(' + m + ')}',
                  '\x3c/script\x3e',
                ].join('')
              );
              d.$.close();
  ...
  (function () {
    ...
    function A() {
      for (
        var a = this._.tabIdList.length, b = CKEDITOR.tools.indexOf(this._.tabIdList, this._.currentTabId), c = b + 1;
        c < b + a;
        c++
      )
        if (this._.tabs[this._.tabIdList[c % a]][0].$.offsetHeight) return this._.tabIdList[c % a];
    ...
    function K(a, b) {
      for (var c = a.$.getElementsByTagName('input'), e = 0, d = c.length; e < d; e++) {
        ...
        'text' == f.getAttribute('type').toLowerCase() &&
          (b
            ? (f.setAttribute('value', f.getCustomData('fake_value') || ''), f.removeCustomData('fake_value'))
            : (f.setCustomData('fake_value', f.getAttribute('value')), f.setAttribute('value', '')));
      }
    }
    function T(a, b) {
      ...
      function b(b) {
        ...
        a.move(
          d.x + h[3] < g
            ...
            : d.x,
          d.y + h[0] < g ? -h[0] : d.y - h[2] > k.height - c.height - g ? k.height - c.height + h[2] : d.y,
          1
        );
      ...
      if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
        var f = a.getParentEditor(),
          ...
          n = CKEDITOR.tools.addFunction(function (d) {
            ...
            h =
              k.height -
              a.parts.contents.getSize('height', !(CKEDITOR.env.gecko || (CKEDITOR.env.ie && CKEDITOR.env.quirks)));
            ...
            CKEDITOR.env.ie6Compat &&
              ((e = u.getChild(0).getFrameDocument()), e.on('mousemove', b), e.on('mouseup', c));
    ...
    function N(a) {
      ...
      g
        ...
        : ((f = [
          ...
          CKEDITOR.env.ie6Compat &&
            ((d = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + d + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e"),
            f.push(
            ...
            f.push(
              'void((function(){' +
                encodeURIComponent(
                  'document.open();(' + CKEDITOR.tools.fixDomain + ")();document.write( '" + d + "' );document.close();"
                ) +
                '})())'
            ),
            f.push(
    ...
    CKEDITOR.dialog = function (a, b) {
      ...
      function d(b) {
        if (l == CKEDITOR.dialog._.currentTop) {
          ...
          if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), (q = 1);
            ...
            (c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? x.call(l) : A.call(l)),
              l.selectPage(c),
              l._.tabs[c][0].focus(),
              (q = 1);
      ...
      var g = CKEDITOR.dialog._.dialogDefinitions[b],
        ...
        q,
        n;
      (('OS' == p && CKEDITOR.env.mac) || ('rtl' == p && 'ltr' == m) || ('ltr' == p && 'rtl' == m)) &&
        h.buttons.reverse();
      ...
      k = CKEDITOR.dialog._.uiElementBuilders.hbox
        .build(this, { type: 'hbox', className: 'cke_dialog_footer_buttons', widths: [], children: g.buttons }, m)
        .getChild();
    ...
    CKEDITOR.dialog.prototype = {
      ...
      resize: (function () {
        return function (a, b) {
          (this._.contentSize && this._.contentSize.width == a && this._.contentSize.height == b) ||
      ...
      move: function (a, b, c) {
        ...
        (f && this._.position && this._.position.x == a && this._.position.y == b) ||
          ...
          d && ((f = this.getSize()), (a = CKEDITOR.document.getWindow().getViewPaneSize().width - f.width - a)),
          (b = { top: (0 < b ? b : 0) + 'px' }),
      ...
      show: function () {
        ...
        null === CKEDITOR.dialog._.currentTop
          ? ((CKEDITOR.dialog._.currentTop = this), (this._.parentDialog = null), N(this._.editor))
      ...
      hidePage: function (a) {
        ...
        b &&
          1 != this._.pageCount &&
          b.isVisible() &&
          (a == this._.currentTabId && this.selectPage(x.call(this)), b.hide(), this._.pageCount--, this.updateStyle());
      },
      showPage: function (a) {
            ...
            if (g.config.enterMode == CKEDITOR.ENTER_BR)
              for (c = !0; a.length; )
                if (((f = a.shift()), 'div' == f.getName())) {
                  ...
                  !c ||
                    !f.getPrevious() ||
                    (f.getPrevious().type == CKEDITOR.NODE_ELEMENT && f.getPrevious().isBlockBoundary()) ||
                    b.append(g.document.createElement('br'));
                  for (
                    c = f.getNext() && !(f.getNext().type == CKEDITOR.NODE_ELEMENT && f.getNext().isBlockBoundary());
                    f.getFirst();
    ...
    r.prototype = {
      ...
      _layout: function () {
        ...
        (g && h) ||
          ...
          (h = this._notificationMargin =
            parseInt(m.getComputedStyle('margin-left'), 10) + parseInt(m.getComputedStyle('margin-right'), 10)));
        ...
        var n =
          'fixed' == a.getStyle('position') ? d.left : 'static' != q.getComputedStyle('position') ? e.x - r.x : e.x;
        d.width < g + h
          ? e.x + g + h > p.x + t.width
            ? b()
            : a.setStyle('left', k(n))
  ...
  (function () {
    ...
    var c =
      ...
      t = CKEDITOR.addTemplate(
        'buttonArrow',
        '\x3cspan class\x3d"cke_button_arrow"\x3e' + (CKEDITOR.env.hc ? '\x26#9660;' : '') + '\x3c/span\x3e'
      ),
    ...
    CKEDITOR.ui.button.prototype = {
      render: function (a, b) {
        function c() {
          var f = a.mode;
          f &&
            ((f = this.modes[f] ? (void 0 !== m[f] ? m[f] : CKEDITOR.TRISTATE_OFF) : CKEDITOR.TRISTATE_DISABLED),
        ...
        if (this.modes) {
          ...
          d &&
            ...
            (g += d.state == CKEDITOR.TRISTATE_ON ? 'on' : d.state == CKEDITOR.TRISTATE_DISABLED ? 'disabled' : 'off'));
        if (this.directional)
          a.on(
            'contentDirChanged',
            function (b) {
              ...
              d.setAttribute('style', CKEDITOR.skin.getIconStyle(l, 'rtl' == b, this.icon, this.iconOffset));
            },
            this
          );
        d
          ? (k = a.getCommandKeystroke(d)) && (h = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, k))
          : (g += 'off');
        ...
        if (e.length) {
          ...
          for (var d; (d = e.shift()); )
            (d = 'string' == typeof d ? d : d.name),
              (b && -1 != CKEDITOR.tools.indexOf(b, d)) || ((d = a.ui.create(d)) && a.addFeature(d) && c.items.push(d));
        }
      }
      function h(b) {
        var a = [],
                  ...
                  if (
                    ((b =
                      9 == h
                        ...
                        : (b ? b.previous : c.toolbar.previous) || a.toolbox.toolbars[a.toolbox.toolbars.length - 1]),
                    b.items.length)
                  )
                    ...
                    if (t) {
                      ...
                      if (t.type == CKEDITOR.UI_SEPARATOR) k = e && t;
                        ...
                        if (!m) {
                          ...
                          w &&
                            b.push('\x3cspan id\x3d"', r, '_label" class\x3d"cke_voice_label"\x3e', w, '\x3c/span\x3e');
                          b.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                          var u = q.push(m) - 1;
                          0 < u && ((m.previous = q[u - 1]), (m.previous.next = m));
                        }
                        A
                          ? e || (b.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), (e = 1))
  ...
  (function () {
        ...
        return {
          ...
          exec: function (a, b) {
            function c(b, h) {
              ...
              b
                ? ((b.method = 'paste'), b.dataTransfer || (b.dataTransfer = p.initPasteDataTransfer()), r(a, b, h))
                : e && a.showNotification(n, 'info', a.config.clipboard_notificationDuration);
        ...
        if (!d.getById('cke_pastebin')) {
          ...
          CKEDITOR.env.webkit
            ? (e.append(l),
              ...
              e.is('body') ||
                ((k = 'static' != e.getComputedStyle('position') ? e : CKEDITOR.dom.element.get(e.$.offsetParent)),
                (k = k.getDocumentPosition().y)))
            : e.getAscendant(CKEDITOR.env.ie ? 'body' : 'html', 1).append(l);
          l.setStyles({
            position: 'absolute',
          ...
          (k = l.getParent().isReadOnly())
            ? (l.setOpacity(0), l.setAttribute('contenteditable', !0))
            : l.setStyle('ltr' == a.config.contentsLangDirection ? 'left' : 'right', '-10000px');
        ...
        get: function (c) {
          return 'plain-text' == c
            ...
            ? ((c = b.semanticContent) ||
                ...
                c.allow({ $1: { elements: a(), attributes: !0, styles: !1, classes: !1 } }),
        ...
        e.attachListener(
          ...
          function () {
            ...
            CKEDITOR.env.ie &&
              ...
              ((b.dragStartContainerChildCount = c ? h(c.startContainer) : null),
    ...
    CKEDITOR.plugins.add('clipboard', {
      ...
      init: function (a) {
        ...
        a.config.forcePasteAsPlainText
          ...
          : !CKEDITOR.env.webkit || 'pasteFilter' in a.config || (b = 'semantic-content');
          ...
          function (b) {
            ...
            if (!b.data.dataValue) {
              ...
              if (d) (b.data.dataValue = d), (b.data.type = 'html');
                ...
                (b.data.dataValue = a.editable().transformPlainTextToHtml(d)), (b.data.type = 'text');
            }
          },
          null,
          null,
        ...
        a.on(
          ...
          function (a) {
            ...
            -1 < b.indexOf('Apple-') &&
              ...
              'html' != a.data.type &&
                (b = b.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi, function (a, b) {
        ...
        a.on(
          ...
          function (b) {
            ...
            'text' == d && 'html' == g
              ? (f = w(a, f, c.get('plain-text')))
              : n == CKEDITOR.DATA_TRANSFER_EXTERNAL && a.pasteFilter && !b.dontFilter && (f = w(a, f, a.pasteFilter));
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      internalDrop: function (a, b, c, d) {
        ...
        CKEDITOR.env.ie &&
          10 > CKEDITOR.env.version &&
          this.fixSplitNodesAfterDrop(a, b, g.dragStartContainerChildCount, g.dragEndContainerChildCount);
      ...
      getRangeAtDropPosition: function (a, b) {
        ...
        if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, g))
            ...
            try {
              ...
              if (f) {
                ...
                if (p.equals(b.editable()) || 'html' == p.getName())
                  return h && h.startContainer && !h.startContainer.equals(b.editable()) ? h : null;
                r = p.getClientRect();
                d < r.left
    ...
    CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
      ...
      b &&
        ...
        'Text' == m || this.getData('text/plain') || this.setData('text/plain', b.getSelection().getSelectedText()));
    };
    ...
    CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
      ...
      setData: function (a, b) {
        ...
        if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || 'URL' == a || 'Text' == a)
          if (('Text' == m && 'Text' == a && (this.id = b), this._.fallbackDataTransfer.isRequired()))
  ...
  (function () {
    ...
    CKEDITOR.ui.panel.prototype = {
      ...
      addBlock: function (a, b) {
        b = this._.blocks[a] =
          b instanceof CKEDITOR.ui.panel.block ? b : new CKEDITOR.ui.panel.block(this.getHolderElement(), b);
        ...
        onKeyDown: function (a, b) {
          ...
          switch (e) {
            ...
            case 'mouseup':
              return (
                (d = this._.focusIndex),
                (c = 0 <= d && this.element.getElementsByTag('a').getItem(d)) && (c.$[e] ? c.$[e]() : c.$['on' + e]()),
                !1
              );
          }
          return !0;
            ...
            e.on(
              ...
              function (a) {
                ...
                this.allowBlur() &&
                  ...
                  !this._.activeChild &&
                  (CKEDITOR.env.iOS
                    ? this._.hideTimeout || (this._.hideTimeout = CKEDITOR.tools.setTimeout(u, 0, this))
                    : u.call(this));
              },
              this
            ),
                ...
                CKEDITOR.env.ie &&
                  ...
                  'rtl' == b.getComputedStyle('direction') &&
                    (d = CKEDITOR.env.ie8Compat
                      ? d - 2 * l.getDocument().getDocumentElement().$.scrollLeft
  ...
  CKEDITOR.plugins.add('menu', {
    ...
    beforeInit: function (l) {
      for (
        var h = l.config.menu_groups.split(','), r = (l._.menuGroups = {}), t = (l._.menuItems = {}), n = 0;
        n < h.length;
        n++
      )
        r[h[n]] = n + 1;
  ...
  (function () {
    ...
    CKEDITOR.env.gecko &&
      (h += ' onblur\x3d"this.style.cssText \x3d this.style.cssText;" ondragstart\x3d"return false;"');
    var h =
        h +
      ...
      proto: {
        ...
        show: function (a, b, d, m) {
          ...
          for (
            var c = k.elementPath(),
              c = [
                '\x3cdiv class\x3d"cke_menu' +
                  (c && c.direction() != k.lang.dir ? ' cke_mixed_dir_content' : '') +
                  '" role\x3d"presentation"\x3e',
              ],
              h = g.length,
              n = h && g[0].group,
            ...
            var p = g[q];
            n != p.group &&
              (c.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'), (n = p.group));
            p.render(this, q, c);
          }
          c.push('\x3c/div\x3e');
          f.setHtml(c.join(''));
      ...
      proto: {
        render: function (a, b, d) {
          ...
          this.command &&
            ...
            (f = e.getCommandKeystroke(f)) && (c = CKEDITOR.tools.keystrokeToString(e.lang.common.keyboard, f)));
          a = {
            id: h,
            name: this.name,
            iconName: p,
      ...
      CKEDITOR.plugins.contextMenu = CKEDITOR.tools.createClass({
        ...
        $: function (a) {
          this.base.call(this, a, {
            panel: { className: 'cke_menu_panel', attributes: { 'aria-label': a.lang.contextmenu.options } },
          });
        },
        proto: {
  ...
  (function () {
    function q(a, c) {
      ...
      var v = CKEDITOR.tools.addFunction(k),
        w = CKEDITOR.tools.addFunction(function (b, e) {
          ...
          switch (e.getKeystroke()) {
            ...
            case 9:
              return (
                (d = CKEDITOR.document.getById(g + (b + 1))) || (d = CKEDITOR.document.getById(g + '0')), d.focus(), !1
              );
            case d ? 37 : 39:
            case CKEDITOR.SHIFT + 9:
              return (
      ...
      a.on('selectionChange', function (b) {
        for (
          var e = [], g = (h.list = []), d = [], c = h.filters, p = !0, k = b.data.path.elements, u = k.length;
          u--;
          ...
          b = f.data('cke-display-name')
            ...
            ? f.data('cke-real-element-type')
            : f.getName();
          (p = f.hasAttribute('contenteditable') ? 'true' == f.getAttribute('contenteditable') : p) ||
            ...
            if (c && (c.is('li') || c.getParent().is('li'))) {
              ...
              if (e.is('li'))
                ...
                if (b)
                  if (
                    (l.block.is('li')
                      ? ((e = f.createElement(d == CKEDITOR.ENTER_P ? 'p' : 'div')),
          ...
          if ((k = a.splitBlock(n))) {
            ...
            if (l || b) {
              ...
              e
                ...
                : g && g.is('li')
                ? (e = g)
                : ((e = f.createElement(n)), d && (p = d.getDirection()) && e.setAttribute('dir', p));
              if ((f = k.elementPath))
              ...
              c.is('li') &&
                ...
                (g = e.next()) &&
                  ...
                  g.is('ul', 'ol') &&
                  (CKEDITOR.env.needsBrFiller ? f.createElement('br') : f.createText(' ')).insertBefore(g)),
      ...
      enterBr: function (b, d, a, h) {
        if ((a = a || v(b))) {
          ...
          h || 'li' != c
            ? (!h && k && w.test(c)
                ? (k = l.getDirection())
                  ? ((f = f.createElement('div')), f.setAttribute('dir', k), f.insertAfter(l), a.setStart(f, 0))
          ...
          if (
            ...
            if (
              ('string' == typeof e.filebrowser &&
                (e.filebrowser = { action: 'fileButton' == e.type ? 'QuickUpload' : 'Browse', target: e.filebrowser }),
      ...
      if ('function' != typeof c || !1 !== c.call(this._.filebrowserSe))
        if (!e || !1 !== e.call(this._.filebrowserSe, a, c))
          if (
            ...
            a && ((b = this._.filebrowserSe), (d = b.getDialog()), (b = b.filebrowser.target || null)))
          )
            ...
            if ((k = a.editable())) {
              ...
              m
                ? (q + r <= c.top ? e('top') : q + r > h.height - c.bottom ? e('pin') : e('bottom'),
                  ...
                  n.width > h.width
                    ? ((d = 'left'), (f = 0))
                    : ((f = 'left' == d ? (0 < c.left ? c.left : 0) : c.right < h.width ? h.width - c.right : 0),
                      f + n.width > h.width && ((d = 'left' == d ? 'right' : 'left'), (f = 0))),
                  b.setStyle(d, w(('pin' == m ? u : p) + f + ('pin' == m ? 0 : 'left' == d ? v : -v))))
                : ((m = 'pin'), e('pin'), t(d));
            }
          };
        })();
    ...
    CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        setValue: function (a, b) {
          ...
          c &&
            (a || b ? c.removeClass('cke_combo_inlinelabel') : ((b = this.label), c.addClass('cke_combo_inlinelabel')),
  ...
  CKEDITOR.plugins.add('format', {
    ...
    init: function (a) {
      if (!a.blockless) {
        for (
          var f = a.config, c = a.lang.format, l = f.format_tags.split(';'), d = {}, m = 0, n = [], g = 0;
          g < l.length;
          g++
        ) {
          var h = l[g],
  ...
  CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
    ...
    proto: {
      ...
      openTagClose: function (b, a) {
        ...
        a
          ? (this._.output.push(this.selfClosingEnd), c && c.breakAfterClose && (this._.needsSpace = c.needsSpace))
          : (this._.output.push('\x3e'), c && c.indent && (this._.indentation += this.indentationChars));
        c && c.breakAfterOpen && this.lineBreak();
        'pre' == b && (this._.inPre = 1);
      },
      attribute: function (b, a) {
        'string' == typeof a &&
          (this.forceSimpleAmpersand && (a = a.replace(/&amp;/g, '\x26')), (a = CKEDITOR.tools.htmlEncodeAttr(a)));
  ...
  (function () {
    function m(a) {
      ...
      CKEDITOR.env.ie && !CKEDITOR.env.edge && b.enterMode != CKEDITOR.ENTER_P
        ? f('p')
        : CKEDITOR.env.edge && 15 > CKEDITOR.env.version && b.enterMode != CKEDITOR.ENTER_DIV && f('div');
    ...
    l = CKEDITOR.tools.createClass({
      ...
      proto: {
          ...
          if (f) this.setHtml(a), this.fixInitialSelection(), b.fire('dataReady');
            ...
            d
              ? (/<body[\s|>]/.test(a) || (a = '\x3cbody\x3e' + a),
                ...
                /<head[\s|>]/.test(a)
                  ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, '$\x26\x3ctitle\x3e\x3c/title\x3e'))
                  : (a = a.replace(/<html[^>]*>/, '$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e')),
        ...
        detach: function () {
          ...
          b && b.getParent()
            ? (b.clearCustomData(), (a = b.removeCustomData('onResize')) && a.removeListener(), b.remove())
          ...
          if (d) {
            if ('left' == a || 'right' == a)
              d.on('exec', function (d) {
                ...
                c &&
                  ((g = f(c)),
                  g == a ? (c.removeStyle('float'), a == f(c) && c.removeAttribute('align')) : c.setStyle('float', a),
                  d.cancel());
              });
      ...
      for (
        ...
        if (!b) {
          ...
          d &&
            d.type == CKEDITOR.NODE_ELEMENT &&
            d.getName() in p &&
            (c.setStartAt(d, CKEDITOR.POSITION_AFTER_START), c.setEndAt(d, CKEDITOR.POSITION_BEFORE_END), (b = d));
        }
        b &&
          ...
          f.on(
            ...
            function (g) {
              ...
              if ('wysiwyg' == f.mode && g.data.keyCode == this.indentKey && c) {
                ...
                !m ||
                  (this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, m)) ||
            ...
            if (
              (b =
                (b =
                  ...
                  new CKEDITOR.htmlParser.fragment.fromHtml(decodeURIComponent(b))) && b.children[0]) &&
  ...
  (function () {
    ...
    CKEDITOR.plugins.add('link', {
      ...
      onLoad: function () {
        ...
        var b =
            'background:url(' +
            CKEDITOR.getUrl(this.path + 'images' + (CKEDITOR.env.hidpi ? '/hidpi' : '') + '/anchor.png') +
      ...
      init: function (c) {
        ...
        c.addCommand(
          'anchor',
          new CKEDITOR.dialogCommand('anchor', { allowedContent: 'a[!name,id]', requiredContent: 'a[name]' })
        );
        ...
        c.on(
          ...
          function (a) {
            ...
            b &&
              ...
              (b.is('a')
                ? ((a.data.dialog =
                    !b.getAttribute('name') || (b.getAttribute('href') && b.getChildCount()) ? 'link' : 'anchor'),
                  (a.data.link = b))
    ...
    CKEDITOR.plugins.link = {
      ...
      getEditorAnchors: function (c) {
        for (
          ...
          (e.data('cke-saved-name') || e.hasAttribute('name')) &&
            d.push({ name: e.data('cke-saved-name') || e.getAttribute('name'), id: e.getAttribute('id') });
      ...
      getLinkAttributes: function (c, b) {
        ...
        switch (b.type) {
          case 'url':
            var a = b.url && void 0 !== b.url.protocol ? b.url.protocol : 'httpClient://',
    ...
    CKEDITOR.removeAnchorCommand.prototype = {
      exec: function (c) {
        ...
        if (
          ...
          (d.getChildCount() ? d.is('a') : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, d))
        )
          d.remove(1);
        else if ((d = CKEDITOR.plugins.link.getSelectedLink(c)))
          d.hasAttribute('href')
            ? (d.removeAttributes({ name: 1, 'data-cke-saved-name': 1 }), d.removeClass('cke_anchor'))
            : d.remove(1);
        b.selectBookmarks(a);
      },
      ...
      function c(c) {
        if (
          !(
            ...
            !(p = m.root[c ? 'getPrevious' : 'getNext'](CKEDITOR.dom.walker.invisible(!0))) ||
            ...
            for (var a = 0, p = h.getChildCount(), l; a < p; a++)
              (l = h.getChild(a)),
                l.type == CKEDITOR.NODE_ELEMENT && v[l.getName()]
                  ? CKEDITOR.plugins.list.listToArray(l, m, e, c + 1, d.grandparent)
                  : d.contents.push(l);
          }
        }
        return e;
        ...
        for (
          ...
          if (r.indent == p) {
            (d && b[a].parent.getName() == d.getName()) ||
              ((d = b[a].parent.clone(!1, 1)), f && d.setAttribute('dir', f), h.append(d));
            ...
            v[g.getName()]
              ? ((l = r.element.clone(!1, !0)), q != g.getDirection(1) && l.setAttribute('dir', q))
            ...
            for (g = 0; g < B; g++)
              if (((w = r.contents[g]), H(w) && 1 < B)) A ? (x = w.clone(1, 1)) : l.append(w.clone(1, 1));
                ...
                A
                  ? (n || ((n = k.createElement(t)), l.append(n), d && n.setAttribute('dir', q)),
            ...
            l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
              ...
              (CKEDITOR.env.needsBrFiller &&
                ...
                q.is('br') &&
                q.remove(),
              ((q = l.getLast(u)) && q.type == CKEDITOR.NODE_ELEMENT && q.is(CKEDITOR.dtd.$block)) ||
        ...
        if (m)
          for (b = h.getFirst(); b; ) {
            if (
              ...
              b.getName() in CKEDITOR.dtd.$listItem && ((e = b), (k = f = c = void 0), (c = e.getDirection())))
            ) {
        ...
        for (
          ...
          for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; (d = g.getNextParagraph()); )
            if (!d.getCustomData('list_block')) {
              ...
              for (
                var l = b.elementPath(d), a = l.elements, p = 0, l = l.blockLimit, q, n = a.length - 1;
                0 <= n && (q = a[n]);
                n--
              )
        ...
        for (q = []; 0 < f.length; )
          if (((a = f.shift()), this.state == CKEDITOR.TRISTATE_OFF))
            if (v[a.root.getName()]) {
              ...
              for (d = 0; d < h.contents.length; d++)
                (n = h.contents[d]),
                  (n = n.getAscendant('li', !0)) &&
                    ...
                    (l.push(n), CKEDITOR.dom.element.setMarker(a, n, 'list_item_processed', !0));
              ...
              1 == l.length &&
                l[0].equals(g.root) &&
                ((a = c.createElement('div')), l[0].moveChildren && l[0].moveChildren(a), l[0].append(a), (l[0] = a));
              ...
              if (!(1 > h.length)) {
                ...
                for (t = d = void 0; h.length; )
                  (d = h.shift()),
                    ...
                    (r = d),
                    r.is('pre') || L.test(r.getName()) || 'false' == r.getAttribute('contenteditable')
                      ? d.appendTo(t)
                      : (d.copyAttributes(t),
                        a && d.getDirection() && (t.removeStyle('direction'), t.removeAttribute('dir')),
                        d.moveChildren(t),
                        d.remove()),
                    t.appendTo(n);
              ...
              if (f && f.collapsed) {
                ...
                if (k) {
                  ...
                  (a = A(a))
                    ? ((c = a),
                      (a = a.getPrevious(u)),
                      e.moveToPosition(a && z(a) ? a : c, CKEDITOR.POSITION_BEFORE_START))
                    : (d.range.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
                      ...
                      (a = d.previous()) &&
                        ...
                        (a.is('li') ||
                          (d.range.selectNodeContents(a), d.reset(), (d.evaluator = G), (a = d.previous())),
                        (c = a),
                  ...
                  if (c) C(b, e, f), m.cancel();
                    ...
                    p &&
                      ...
                      f.checkBoundaryOfElement(c, CKEDITOR.START) &&
                        ((a = p.getPrevious(u)),
                        A(c) ? a && (f.moveToElementEditEnd(a), f.select()) : b.execCommand('outdent'),
                        m.cancel()));
                  }
                  ...
                  if (
                    ...
                    (g = 0),
                    (a = d.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in v && a.equals(h)
                      ? ((g = 1), (a = d.next()))
                  ...
                  d.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END),
                    (a = d.next()) &&
                      ...
                      g.block && f.checkStartOfBlock() && f.checkEndOfBlock()
                        ? (g.block.remove(), f.moveToElementEditStart(a), f.select())
                        : A(a)
                        ? (f.moveToElementEditStart(a), f.select())
                        : ((f = f.clone()), f.moveToElementEditStart(a), C(b, e, f)),
                      m.cancel());
                setTimeout(function () {
                  b.selectionChange(1);
                });
  ...
  (function () {
    ...
    function la(a) {
      var c = a.doc,
        ...
        b = CKEDITOR.getUrl(
          this.path + 'images/' + (t.hidpi ? 'hidpi/' : '') + 'icon' + (a.rtl ? '-rtl' : '') + '.png'
        );
      v(d, {
        attach: function () {
          ...
          v(
            ...
            ),
            {
              base:
                ...
                a.boxColor +
                ';cursor:pointer;' +
                (t.hc ? 'font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;' : '') +
        ...
        place: function () {
          ...
          d.is(C) || q(m.top, b.scroll.y - 15, b.scroll.y + 5)
            ...
            ? ((m.top = a.inInlineMode
                ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom
                : b.pane.bottom - 1),
              this.look(D))
            : (a.inInlineMode && (m.top -= b.editable.top + b.editable.border.top), this.look(x));
        ...
        exec: (function () {
          ...
          return function (b) {
            ...
            if (!aa(a, b) && b && !b.equals(a.editable) && !b.contains(a.editable)) {
              ...
              e = w(a, b, !c);
              var f;
              n(e) && e.is(a.triggers) && e.is(ma) && (!w(a, e, !c) || ((f = w(a, e, !c)) && n(f) && f.is(a.triggers)))
                ? d(e)
                : ((f = O(a, b)), n(f) && (w(a, f, !c) ? (b = w(a, f, !c)) && n(b) && b.is(a.triggers) && d(f) : d(f)));
            }
          };
        })(),
      };
    ...
    function aa(a, c) {
      ...
      for (var d = c.getParents(1), b = d.length; b--; )
        for (var e = a.tabuList.length; e--; ) if (d[b].hasAttribute(a.tabuList[e])) return !0;
      return !1;
    }
    function na(a, c, d) {
    ...
    function ca(a) {
      ...
      var f =
          d.y >
          (a.inInlineMode ? b.editable.top + b.editable.height / 2 : Math.min(b.editable.height, b.pane.height) / 2),
      ...
      return !f && 0 <= c.size.top && q(d.y, 0, c.size.top + e)
        ...
        ? ((a = a.inInlineMode || q(c.size.bottom, b.pane.height - e, b.pane.height) ? D : x),
          new z([c, null, da, M, a]))
        : null;
    }
    function ea(a) {
      ...
      if (g) {
        ...
        e.equals(a.editable[h ? 'getLast' : 'getFirst'](a.isRelevant))
          ? (H(a),
            h && q(c.y, e.size.bottom - b, d.pane.height) && q(e.size.bottom, d.pane.height - b, d.pane.height)
              ? (k = D)
          ...
          (f = [null, e]
            ...
            .concat([
              ...
              M,
              k,
              e.equals(a.editable[h ? 'getLast' : 'getFirst'](a.isRelevant)) ? (h ? D : C) : x,
            ]));
      ...
      init: function (a) {
        ...
        a.on(
          ...
          function () {
            ...
            d.is(B.$inline) ||
              (b.inInlineMode && !ba(d) && d.setStyles({ position: 'relative', top: null, left: null }),
              la.call(this, b),
              N(b),
                ...
                if ('wysiwyg' == a.mode)
                  if (b.inInlineMode) {
                    ...
                    var e = b.view.editable,
                      f = b.view.scroll;
                    (d > e.left - f.x && d < e.right - f.x && c > e.top - f.y && c < e.bottom - f.y) ||
                ...
                if ('wysiwyg' == a.mode && !a.readOnly && !k) {
                  ...
                  k = setTimeout(function () {
                    ...
                    f &&
                      ...
                      !b.line.mouseNear() &&
                      (b.element = ha(b, !0)) &&
                      ((b.trigger = ca(b) || ea(b) || ia(b)) && !aa(b, b.trigger.upper || b.trigger.lower)
                        ? b.line.attach().place()
      ...
      ia = (function () {
        function a(a) {
          ...
          for (var b = Number.MAX_VALUE, h, g, l, p; f && !f.equals(e) && (g = e.getNext(a.isRelevant)); )
            (h = Math.abs(ka(a, e, g) - a.mouse.y)), h < b && ((b = h), (l = e), (p = g)), (e = g), r(a, e);
        ...
        return function (c) {
          ...
          if ((e = b)) {
            ...
            var f = b.lower;
            e =
              !e || !f || u(f) || u(e) || f.equals(e) || e.equals(f) || f.contains(e) || e.contains(f)
                ? !1
                : L(c, e) && L(c, f) && V(c, e, f)
                ? !0
                : !1;
    ...
    function v(a) {
      if (!a.editable().isInline()) {
        ...
        for (f in e) {
          ...
          'wysiwyg' != b.mode ||
            b.readOnly ||
            ((b = b.document.getBody()), b.setAttribute('contentEditable', !1), b.setAttribute('contentEditable', !0));
        }
    ...
    CKEDITOR.plugins.add('maximize', {
      init: function (a) {
        ...
        if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
            ...
            exec: function () {
              ...
              if (this.state == CKEDITOR.TRISTATE_OFF) {
                ...
                for (d = a.container; (d = d.getParent()); )
                  d.setCustomData('maximize_saved_styles', r(d)), d.setStyle('z-index', a.config.baseFloatZIndex - 5);
                ...
                for (var d = [g, h], q = 0; q < d.length; q++)
                  u(d[q], d[q].getCustomData('maximize_saved_styles')), d[q].removeCustomData('maximize_saved_styles');
                for (d = a.container; (d = d.getParent()); )
                  u(d, d.getCustomData('maximize_saved_styles')), d.removeCustomData('maximize_saved_styles');
                CKEDITOR.env.ie
                  ? setTimeout(function () {
                      c.$.scrollTo(p.x, p.y);
                    }, 0)
          ...
          a.ui.addButton &&
            a.ui.addButton('Maximize', { label: f.maximize.maximize, command: 'maximize', toolbar: 'tools,10' });
          a.on(
            'mode',
            function () {
        ...
        var c = a.lang,
          ...
          d =
            b && 'undefined' !== typeof b.notification
              ? b.notification
              : !b || !b.from || ('keystrokeHandler' === b.from && CKEDITOR.env.ie),
          c =
            d && 'string' === typeof d
              ? d
              : c.pastetext.pasteNotification.replace(
                  /%1/,
                  '\x3ckbd aria-label\x3d"' + e.aria + '"\x3e' + e.display + '\x3c/kbd\x3e'
                );
  ...
  (function () {
    function l(a, f, e) {
      ...
      h
        ? e()
        : ((a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || f + 'filter/default.js')),
      ...
      init: function (a) {
        function f(a) {
          ...
          if (
                    ...
                    d.push(
                      a.type
                        ? 'data:' +
                            a.type +
                            ';base64,' +
                            CKEDITOR.tools.convertBytesToBase64(CKEDITOR.tools.convertHexStringToBytes(a.hex))
                        : null
                    );
                  },
                  this
            ...
            for (b = 0; b < c.length; b++)
              0 === c[b].indexOf('file://') && d[b] && (a.data.dataValue = a.data.dataValue.replace(c[b], d[b]));
        }
        var e = 0,
          h = this.path,
        ...
        a.on(
          ...
          function (f) {
            var b = f.data,
              c = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported
            ...
            if (c && (e || d) && (!1 !== a.fire('pasteFromWord', g) || e)) {
              ...
              var k = l(a, h, function () {
                if (k) a.fire('paste', b);
                  ...
                  (g.dataValue = CKEDITOR.cleanWord(g.dataValue, a)),
                    a.fire('afterPasteFromWord', g),
                    (b.dataValue = g.dataValue);
                e = 0;
              });
              k && f.cancel();
            }
        ...
        exec: function (a) {
          for (
            var h =
                ...
                (a._.removeFormatRegex = new RegExp('^(?:' + a.config.removeFormatTags.replace(/,/g, '|') + ')$', 'i')),
                ...
                if (b.isReadOnly()) {
                  ...
                  (k = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT)),
                    ('img' == b.getName() && b.data('cke-realelement')) ||
                      !f(a, b) ||
                      (h.test(b.getName()) ? b.remove(1) : (b.removeAttributes(e), a.fire('removeFormatCleanup', b))),
                    (b = k);
            c.moveToBookmark(l);
          }
          a.forceNextSelectionCheck();
      ...
      init: function (a) {
        ...
        a.on('removeFormatCleanup', function (d) {
          ...
          a.getCommand('showborders').state == CKEDITOR.TRISTATE_ON &&
            d.is('table') &&
            (!d.hasAttribute('border') || 0 >= parseInt(d.getAttribute('border'), 10)) &&
            ...
            : ((a.previousState = a.state),
              b ||
                ((b = a.menu = new CKEDITOR.menu(c, {
                  panel: { className: 'cke_menu_panel', attributes: { 'aria-label': c.lang.common.options } },
                })),
  ...
  CKEDITOR.plugins.add('scayt', {
      ...
      a.contextMenu &&
        ...
        (a.contextMenu.addListener(function (b, d) {
          ...
          h &&
            ...
            h.showBanner('.' + a.contextMenu._.definition.panel.className.split(' ').join(' .')));
          return k;
        }),
    ...
    parseConfig: function (a) {
      ...
      'string' !== typeof a.config.scayt_customerId &&
        (a.config.scayt_customerId = '1:WvF0D4-UtPqN1-43nkD4-NKvUm2-daQqk3-LmNiI-z7Ysb4-mwry24-T8YrS3-Q2tpq2');
      ...
      'string' !== typeof a.config.scayt_srcUrl &&
        ...
        (c = -1 != c.search(/https?:/) ? c : 'httpClient:'),
    ...
    addRule: function (a) {
      var c = CKEDITOR.plugins.scayt,
        ...
        g = function (b) {
          if (
            a.scayt &&
            (b.hasAttribute(c.options.data_attribute_name) || b.hasAttribute(c.options.problem_grammar_data_attribute))
          )
            return !1;
        },
        h = function (b) {
          ...
          elements: {
            span: function (a) {
              var b = a.hasClass(c.options.misspelled_word_class) && a.attributes[c.options.data_attribute_name],
                d =
                  a.hasClass(c.options.problem_grammar_class) && a.attributes[c.options.problem_grammar_data_attribute];
              c && (b || d) && delete a.name;
              return a;
            },
          },
        ...
        if (d)
          for (d = 0; d < c.length; d++) {
            ...
            d < a.config.scayt_maxSuggestions
              ? (a.addMenuItem(k, { label: c[d], command: k, group: 'scayt_suggest', order: d + 1 }),
                (b[k] = CKEDITOR.TRISTATE_OFF))
              : (a.addMenuItem(k, { label: c[d], command: k, group: 'scayt_moresuggest', order: d + 1 }),
          ...
          for (d = 0; d < c.length; d++)
            (k = 'grayt_suggest_' + CKEDITOR.plugins.scayt.suggestions[d].replace(' ', '_')),
              a.addCommand(k, this.createCommand(CKEDITOR.plugins.scayt.suggestions[d], f, g)),
              a.addMenuItem(k, { label: c[d], command: k, group: 'grayt_suggest', order: d + 1 }),
              (b[k] = CKEDITOR.TRISTATE_OFF);
      else
    ...
    menuGenerator: function (a, c) {
      ...
      h
        ...
        : k &&
          ...
          b.grayt_problemdescription && m && (b.grayt_problemdescription.label = m),
          d.fire('getGrammarSuggestionsList', { lang: g, phrase: e }),
          (e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, h)));
      if (h && 'off' == a.config.scayt_contextCommands) return e;
      for (var l in b)
        (h && -1 == CKEDITOR.tools.indexOf(f, l.replace('scayt_', '')) && 'all' != a.config.scayt_contextCommands) ||
          (k &&
  ...
  CKEDITOR.plugins.scayt = {
    ...
    reloadMarkup: function (a) {
      ...
      a &&
        ...
        a.reloadMarkup
          ? a.reloadMarkup()
          : (this.alarmCompatibilityMessage(), c && c.ltr && c.rtl && a.fire('startSpellCheck, startGrammarCheck')));
    },
  ...
  CKEDITOR.on('scaytReady', function () {
    if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
      ...
      a.resetDirty = CKEDITOR.tools.override(a.resetDirty, function (a) {
        return function () {
          var b = this.scayt;
          CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[this.name] && this.scayt
      ...
      a[c] = CKEDITOR.tools.override(a[c], function (a) {
        return function (b) {
          ...
          CKEDITOR.plugins.scayt &&
            ...
            b.editor.scayt &&
            ((this.contents = c.removeMarkupFromString(f) || ''), (b.contents = c.removeMarkupFromString(g) || ''));
          ...
          if ((a = a.data.styles)) {
            for (var b, h, d, e = 0, n = a.length; e < n; e++)
              ...
              (c.blockless && b.element in CKEDITOR.dtd.$block) ||
                ...
                ((h = b.name), (b = new CKEDITOR.style(b)), c.filter.customConfig && !c.filter.check(b))) ||
                ((b._name = h),
                (b._.enterMode = l.enterMode),
                (b._.type = d = b.assignedTo || b.type),
                (b._.weight = e + 1e3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3)),
                (f[h] = b),
                k.push(b),
                m.push(b));
            k.sort(function (a, b) {
  ...
  CKEDITOR.dom.element.prototype.focusPrevious = function (k, h) {
    for (
      var g = void 0 === h ? this.getTabIndex() : h, f, c, d, e = 0, b, a = this.getDocument().getBody().getLast();
  ...
  (function () {
    function q(d, f) {
      ...
      function c(b) {
        0 < e.length ||
          ...
          (CKEDITOR.dom.element.setMarker(a, b, 'selected_cell', !0), e.push(b));
      }
      var e = [],
        a = {};
      if (!d) return e;
          ...
          for (h.guard = c; (l = h.next()); )
            (l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table)) ||
              ((l = l.getAscendant({ td: 1, th: 1 }, !0)) &&
                ...
                b(l) &&
                (CKEDITOR.dom.element.setMarker(a, l, 'selected_cell', !0), e.push(l)));
        }
      }
      ...
      for (m = k; m <= h; m++)
        for (n = 0; n < g.length; n++)
          (a = g[n]),
            ...
            a.$ &&
              (1 == a.$.colSpan ? a.remove() : --a.$.colSpan, (n += a.$.rowSpan - 1), e.$.cells.length || l.push(e));
      k =
        g[0].length - 1 > h
    ...
    function z(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        a: {
          ...
          (a = a.getPrevious())
            ? (e = a.getLast())
            : ((a = b[e].getParent()), (e = (a = a.getNext()) ? a.getChild(0) : null));
        }
        d.reset();
        for (d = b.length - 1; 0 <= d; d--) z(b[d]);
        e ? p(e, !0) : c && (f[0].moveToPosition(c, CKEDITOR.POSITION_BEFORE_START), f[0].select(), c.remove());
      } else
        d instanceof CKEDITOR.dom.element && ((f = d.getParent()), 1 == f.getChildCount() ? f.remove() : d.remove());
    }
    function p(d, f) {
      var b = d.getDocument(),
        c = CKEDITOR.document;
        ...
        b ||
          ...
          a.getChildren().count() &&
            (t == r ||
              ...
              ((r = u.getLast(CKEDITOR.dom.walker.whitespaces(!0))), !r || (r.is && r.is('br')) || u.append('br')),
            a.moveChildren(u)),
    ...
    function C(d, f) {
      ...
      if (1 < h) {
        ...
        for (
          h = l = 1, e = c.clone(), e.insertAfter(c), e.append((c = b.clone())), m = A(a, g), k = 0;
          k < m.length;
          k++
        )
          m[k].rowSpan++;
  ...
  (function () {
        ...
        for (h = f; h <= p; h++)
          (d = new CKEDITOR.dom.element(e[c][h])),
            d.$ &&
              ...
              (l.push(d), CKEDITOR.dom.element.setMarker(k, d, 'selected_cell', !0));
      CKEDITOR.dom.element.clearAllMarkers(k);
      return l;
    }
    function H(a) {
    ...
    function K(a, b, c) {
      ...
      (e = g.active && !g.first) &&
        !(e = b) &&
        ((e = a.getSelection().getRanges()), (e = 1 < d.length || (e[0] && !e[0].collapsed) ? !0 : !1));
    ...
    function L(a) {
      ...
      if (b && (y(a), b.isInTable() && b.isFake)) {
        ...
        0 < d.length &&
          ...
          d[0].getAscendant('table').data('cke-table-faked-selection-table', ''));
        a.fire('unlockSnapshot');
      }
    }
    function n(a) {
    ...
    function v(a) {
      ...
      function d(a, d, e, k) {
        return ('mousedown' !== a.name || (CKEDITOR.tools.getMouseButton(a) !== CKEDITOR.MOUSE_BUTTON_LEFT && k)) &&
      ...
      if (a.data.getTarget().getName && ('mouseup' === a.name || !B(a.data.getTarget()))) {
        ...
        !g.active &&
          ...
          l &&
          ((g = { active: !0 }), CKEDITOR.document.on('mouseup', v, null, { editor: e }));
        (k || l) && K(e, k || l, a);
        'mouseup' === a.name &&
          (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT &&
    ...
    function N(a, b) {
      ...
      h.getById('cke_table_copybin') ||
        ...
        p.setStyles({ position: 'absolute', width: '1px', height: '1px', overflow: 'hidden' }),
        p.setStyle('ltr' == a.config.contentsLangDirection ? 'left' : 'right', '-5000px'),
    ...
    q.prototype.insertRow = function (a, b, c) {
      ...
      for (
        var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, h = c ? [] : this.cells.all, m, l = 0;
        l < a;
        l++
      )
        (m = E(c ? this.cells.all : h, b)),
          (m = CKEDITOR.tools.array.filter(m.find('td, th').toArray(), function (a) {
    ...
    q.prototype.insertColumn = function (a) {
      ...
      for (var c = this.cells, d = c.all, e = n(c.first), h = n(c.last), c = 0; c < a; c++)
    ...
    var G = {
      onPaste: function (a) {
        ...
        !h.length ||
          ...
          m
            ? (a.stop(),
              l ? (k.insertRow(1, 1 === l, !0), e.selectElement(k.rows.first)) : (k.emptyCells(), t(d, k.cells.all)),
              (a = k.getTableMap()),
          ...
          for (l = new CKEDITOR.dom.element(h.$.rows[a.rows.first.$.rowIndex + f]), p = 0; p < c[f].length; p++)
            if (
              ...
              if (d && d.getParent()) k.replace(d);
                ...
                (d = 0 !== p ? new CKEDITOR.dom.element(c[f][p - 1]) : null) && l.equals(d.getParent())
                  ? k.insertAfter(d)
                  : 0 < e
                  ? l.$.cells[e]
            ...
            return function (l) {
              ...
              if (h[k] && (f = a.getSelection()) && f.isInTable() && f.isFake)
                if (
                  ...
                  g[0].moveToElementEditablePosition(m ? n : q, !m), f.selectRanges([g[0]]);
                else {
        ...
        c.attachListener(
          ...
          function (d) {
            ...
            if (c && c.isInTable() && c.isFake && h && !(d.data.getKeystroke() & CKEDITOR.CTRL)) {
              d = c.getRanges();
              h = d[0].getEnclosedNode().getAscendant({ td: 1, th: 1 }, !0);
    ...
    CKEDITOR.plugins.add('tableselection', {
      ...
      init: function (a) {
        CKEDITOR.plugins.tableselection.isSupportedEnvironment &&
          (a.addContentsCss && a.addContentsCss(this.path + 'styles/tableselection.css'),
          a.on('contentDom', function () {
            var b = a.editable(),
      ...
      getNextImage: function (a) {
        ...
        if (c)
          if (a)
            ...
            for (d = this.index + 1; d < b.length; d++) if (((a = b[d]), !c.equalsContent(a))) return (a.index = d), a;
        return null;
      },
      redoable: function () {
    ...
    function p(a, d) {
      ...
      b.attachListener(
        ...
        function (a) {
          ...
          a = a.data.$.clientY;
          this.queryViewport();
          (b <= this.rect.left || b >= this.rect.right || a <= this.rect.top || a >= this.rect.bottom) &&
            this.hideVisible();
          ...
          for (var c in d)
            (b = d[c]),
              ...
              b.type & CKEDITOR.LINEUTILS_INSIDE &&
                this.store(c, CKEDITOR.LINEUTILS_INSIDE, (b.elementRect.top + b.elementRect.bottom) / 2);
          ...
          a.on('contentDom', function (a) {
            ...
            e.attachListener(
              ...
              function (a) {
                var c = a.data.$;
                65 == a.data.getKey() &&
                  ((CKEDITOR.env.mac && c.metaKey) || (!CKEDITOR.env.mac && c.ctrlKey)) &&
                  CKEDITOR.tools.setTimeout(function () {
      ...
      removeFiller: function (a, b) {
        if (a) {
          ...
          g && 0 < g.length && g != this.fillerContent
            ? (b.insertHtmlIntoRange(g, c.getSelection().getRanges()[0]),
              e.setStartAt(b.getChild(b.getChildCount() - 1), CKEDITOR.POSITION_BEFORE_END),
              c.getSelection().selectRanges([e]))
            : f &&
              (d
                ? e.setStartAt(b.getFirst().getNext(), CKEDITOR.POSITION_AFTER_START)
                : e.setEndAt(b.getLast().getPrevious(), CKEDITOR.POSITION_BEFORE_END),
              b.editor.getSelection().selectRanges([e]));
        }
      },
  ...
  (function () {
    ...
    function q(a, b, c) {
      ...
      CKEDITOR.dtd[this.getName()].p
        ? ((this.enterMode = b ? b.getAllowedEnterMode(a.enterMode) : a.enterMode),
          (this.shiftEnterMode = b ? b.getAllowedEnterMode(a.shiftEnterMode, !0) : a.shiftEnterMode))
    ...
    function S(a, b) {
      function c(a, c) {
        var d = b.upcast.split(','),
          e,
          f;
        for (f = 0; f < d.length; f++) if (((e = d[f]), e === a.name)) return b.upcasts[e].call(this, a, c);
        return !1;
      }
      function d(b, c, d) {
        ...
        if (b) {
          ...
          if (a && a.initOnlyNew) c = this.initOnAll();
            ...
            for (e = l.count(); d < e; d++) {
              ...
              h &&
                b.contains(f) &&
                (f.addClass('cke_widget_new'), c.push(this.initOn(f.getFirst(g.isDomWidgetElement))));
            }
          }
    ...
    function x(a, b, c) {
      ...
      a = d[b];
      a ||
        ((a = c.allowedContent ? new CKEDITOR.filter(c.allowedContent) : this.editor.filter.clone()),
        (d[b] = a),
    ...
    function y(a, b) {
      return {
        ...
        'data-cke-filter': 'off',
        class:
          'cke_widget_wrapper cke_widget_new cke_widget_' + (a ? 'inline' : 'block') + (b ? ' cke_widget_' + b : ''),
      };
    }
    function z(a, b, c) {
      if (a.type == CKEDITOR.NODE_ELEMENT) {
    ...
    function O(a) {
      ...
      b.on('dragstart', function (c) {
        ...
        g.isDomDragHandler(e) &&
          ((e = a.getByElement(e)), c.data.dataTransfer.setData('cke/widget-id', e.id), b.focus(), e.focus());
      });
      b.on('drop', function (c) {
        ...
        '' !== f && h === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS
          ...
          : '' !== f &&
            ...
            c.data.dataTransfer.setData('text/html', b.editable().getHtmlFromRange(e).getHtml()),
    ...
    function M(a) {
      ...
      b.on('contentDom', function () {
        ...
        c.attachListener(d, 'mousedown', function (c) {
          ...
          f = 0;
          e &&
            (e.inline && d.type == CKEDITOR.NODE_ELEMENT && d.hasAttribute('data-cke-widget-drag-handler')
      ...
      b.on(
        ...
        function (b) {
          ...
          if (d && !g.getNestedEditable(d.wrapper, b.data.element))
          ...
          b.data.dataValue.forEach(
            function (b) {
              ...
              if ('data-cke-widget-id' in c) {
                ...
                return (f[f.length - 1].editables[c['data-cke-widget-editable']] = b), !1;
            },
            CKEDITOR.NODE_ELEMENT,
            !0
          );
    ...
    function I(a) {
      ...
      b.on(
        ...
        function (b) {
          ...
          c = b.data.protectedWhitespaces
            ...
            : 1 == b.data.dataValue.children.length && g.isParserWidgetWrapper(b.data.dataValue.children[0]);
        },
        null,
        null,
        8
      ...
      b.on('dataReady', function () {
        if (d)
          for (var c = b.editable().find('.cke_widget_wrapper'), f, h, l = 0, k = c.count(); l < k; ++l)
            (f = c.getItem(l)),
              (h = f.getFirst(g.isDomWidgetElement)),
              h.type == CKEDITOR.NODE_ELEMENT && h.data('widget') ? (h.replace(f), a.wrapElement(h)) : f.remove();
        d = 0;
        a.destroyAll(!0);
        a.initOnAll();
      });
        ...
        commit: function () {
          ...
          for (f && (h = a.focused) && t(a, h); (h = d.pop()); )
            b.splice(CKEDITOR.tools.indexOf(b, h), 1),
              h.isInited() && ((g = h.editor.checkDirty()), h.setSelected(!1), !g && h.editor.resetDirty());
          f &&
            e &&
    ...
    function aa(a) {
      if (a.draggable) {
        ...
        c
          ...
          : ((c = new CKEDITOR.dom.element('span', b.document)),
            c.setAttributes({
              ...
              style:
                'background:rgba(220,220,220,0.5);background-image:url(' + b.plugins.widget.path + 'images/handle.png)',
            }),
        ...
        if (!a.inline && (d.on('mousedown', ba, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version))
    ...
    function ba(a) {
      function b() {
        ...
        CKEDITOR.tools.isEmpty(e.visible) ||
          ((c = d.getRange(c[0])), this.focus(), f.fire('drop', { dropRange: c, target: c.startContainer }));
    ...
    function da(a) {
      if (a.mask) {
        ...
        b ||
          ...
          b.setAttributes({ src: CKEDITOR.tools.transparentImageData, class: 'cke_reset cke_widget_mask' }),
          a.wrapper.append(b));
        a.mask = b;
      }
    }
      ...
      CKEDITOR.style.addCustomHandler({
        ...
        setup: function (a) {
          ...
          if ((this.group = 'string' == typeof a.group ? [a.group] : a.group)) {
            ...
            var b;
            c[a] || (c[a] = {});
            for (var f = 0, h = this.group.length; f < h; f++)
              (b = this.group[f]), c[a][b] || (c[a][b] = []), c[a][b].push(this);
          }
        },
        apply: function (a) {
          var b;
          a instanceof CKEDITOR.editor &&
            ...
            ((b = a.widgets.focused), this.group && this.removeStylesFromSameGroup(a), b.applyStyle(this));
        },
        remove: function (a) {
          a instanceof CKEDITOR.editor &&
            this.checkApplicable(a.elementPath(), a) &&
          ...
          if (this.checkApplicable(f, a))
            for (var g = 0, k = this.group.length; g < k; g++) {
              ...
              for (var m = 0; m < b.length; m++)
                b[m] !== this && b[m].checkActive(f, a) && (a.widgets.focused.removeStyle(b[m]), (h = !0));
            }
          return h;
        },
        checkActive: function (a, b) {
        ...
        checkElement: function (a) {
          return g.isDomWidgetWrapper(a)
            ? (a = a.getFirst(g.isDomWidgetElement)) && a.data('widget') == this.widget
            : !1;
        },
        buildPreview: function (a) {
    ...
    p.prototype = {
      ...
      finalizeCreation: function (a) {
        (a = a.getFirst()) &&
          ...
          (this.editor.insertElement(a), (a = this.getByElement(a)), (a.ready = !0), a.fire('ready'), a.focus());
      },
      ...
      initOn: function (a, b, c) {
        ...
        return d
          ? d.hasClass('cke_widget_new')
            ? ((a = new g(this, this._.nextId++, a, b, c)), a.isInited() ? (this.instances[a.id] = a) : null)
            : this.getByElement(a)
          : null;
      },
    ...
    g.prototype = {
      ...
      destroy: function (a) {
        ...
        a ||
          ('0' == this.element.data('cke-widget-keep-attr') && this.element.removeAttribute('data-widget'),
      ...
      initEditable: function (a, b) {
        ...
        return c && c.is(CKEDITOR.dtd.$editable)
          ? ((c = new q(this.editor, c, { filter: x.call(this.repository, this.name, a, b) })),
            (this.editables[a] = c),
            c.setAttributes({
            ...
            c.on('focus', H, this),
            CKEDITOR.env.ie && c.on('blur', G, this),
      ...
      updateDragHandlerPosition: function () {
        ...
        (c && b.x == c.x && b.y == c.y) ||
          ((c = a.checkDirty()),
          a.fire('lockSnapshot'),
          this.dragHandlerContainer.setStyles({ top: b.y + 'px', left: b.x + 'px', display: 'block' }),
          a.fire('unlockSnapshot'),
          !c && a.resetDirty(),
  ...
  (function () {
    ...
    function k(a, d, b) {
      ...
      this.lang = a.lang;
      'string' === typeof d
        ? ((this.data = d), (this.file = m(this.data)), (this.loaded = this.total = this.file.size))
        : ((this.data = null), (this.file = d), (this.total = this.file.size), (this.loaded = 0));
      b
        ? (this.fileName = b)
        : this.file.name
        ? (this.fileName = this.file.name)
        : ((a = this.file.type.split('/')), c && (a[0] = c), (this.fileName = a.join('.')));
      this.uploaded = 0;
          ...
          function (a) {
            ...
            try {
              ...
              (f.message = b.lang.filetools.responseError),
                CKEDITOR.warn('filetools-response-error', { responseText: c.responseText }),
                a.cancel();
            }
          },
          null,
      ...
      upload: function (a, d) {
        ...
        a
          ? ((this.uploadUrl = a),
            ...
            this.editor.fire('fileUploadRequest', { fileLoader: this, requestData: b }) &&
              this.changeStatus('uploading'))
          : ((this.message = this.lang.filetools.noUrlError), this.changeStatus('error'));
      },
          ...
          if ('abort' != b.status)
            if (((b.uploaded = b.uploadTotal), 200 > c.status || 299 < c.status))
              (b.message = b.lang.filetools['httpError' + c.status]),
                b.message || (b.message = b.lang.filetools.httpError.replace('%1', c.status)),
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
      ...
      getUploadUrl: function (a, d) {
        ...
        return d && a[d + 'UploadUrl']
          ...
          ? a['filebrowser' + b(d, 1) + 'UploadUrl'] + '\x26responseType\x3djson'
  ...
  (function () {
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
              ...
              if (!f.dataValue && e)
                for (n = 0; n < e; n++)
                  if (((d = g.getFile(n)), !l.supportedTypes || k.isTypeSupported(d, l.supportedTypes))) {
                    ...
                    d = c.create(d);
                    m &&
                      (d[h](l.uploadUrl, l.additionalRequestParameters),
                      CKEDITOR.fileTools.markElement(m, b, d.id),
                      ('loadAndUpload' != h && 'upload' != h) ||
                        l.skipNotifications ||
                        CKEDITOR.fileTools.bindNotifications(a, d),
                      (f.dataValue += m.getOuterHtml()));
                  }
            },
            null,
            null,
          ...
          init: function () {
            ...
            g.on('update', function (c) {
              if (f.wrapper && f.wrapper.getParent()) {
                a.fire('lockSnapshot');
                c = 'on' + e(g.status);
                if ('function' !== typeof f[c] || !1 !== f[c](g))
                  (d = 'cke_upload_' + g.status),
                    f.wrapper && d != h && (h && f.wrapper.removeClass(h), f.wrapper.addClass(d), (h = d)),
                    ('error' != g.status && 'abort' != g.status) || a.widgets.del(f);
                a.fire('unlockSnapshot');
              } else
                a
                  .editable()
                  .find('[data-cke-upload-id\x3d"' + b + '"]')
                  .count() || g.abort(),
                  c.removeListener();
            });
            g.update();
      ...
      markElement: function (a, b, e) {
        a.setAttributes({ 'data-cke-upload-id': e, 'data-widget': b });
      },
      bindNotifications: function (a, b) {
        function e() {
          k = a._.uploadWidgetNotificaionAggregator;
          if (!k || k.isFinished())
            (k = a._.uploadWidgetNotificaionAggregator = new CKEDITOR.plugins.notificationAggregator(
              a,
              a.lang.uploadwidget.uploadMany,
              a.lang.uploadwidget.uploadOne
            )),
              k.once('finished', function () {
                var b = k.getTaskCount();
                0 === b
                  ? k.notification.hide()
                  : k.notification.update({
        ...
        b.on('update', function () {
          !c && b.uploadTotal && (e(), (c = k.createTask({ weight: b.uploadTotal })));
              ...
              if (b.data.dataValue.match(/<img[\s\S]+data:/i)) {
                ...
                for (k = 0; k < m.count(); k++) {
                  ...
                  h &&
                    ...
                    !g.isReadOnly(1) &&
                    ((h = ((h = d.match(/image\/([a-z]+?);/i)) && h[1]) || 'jpg'),
