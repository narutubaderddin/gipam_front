...
- [#13816](https://dev.ckeditor.com/ticket/13816): Introduced a new strategy for Filling Character handling to avoid changes in DOM. This fixes the following issues:
  ...
  _ [#13389](https://dev.ckeditor.com/ticket/13389): [Blink][`editor.getdata()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-method-getData) fails when the cursor is next to an `<hr>` tag.
  _ [#13513](https://dev.ckeditor.com/ticket/13513): [Blink, WebKit][div editing area](https://ckeditor.com/cke4/addon/divarea) and [`editor.getData()`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-method-getData) throw an error when an image is the only data in the editor.
...
- Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type): - New features: - CKEditor [Language](https://ckeditor.com/cke4/addon/language) plugin support. - CKEditor [Placeholder](https://ckeditor.com/cke4/addon/placeholder) plugin support. - [Drag&Drop](https://sdk.ckeditor.com/samples/fileupload.html) support. - **Experimental** [GRAYT](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-grayt_autoStartup) (Grammar As You Type) functionality. - Fixed issues:
...
- [#13129](https://dev.ckeditor.com/ticket/13129) Fixed: DirectorBlock widget blurred after a drop followed by an undo.
...
- [#11027](https://dev.ckeditor.com/ticket/11027): Fixed: DirectorBlock commands break on widgets; added the [`contentDomInvalidated`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.editor-event-contentDomInvalidated) event.
...
- [#10914](https://dev.ckeditor.com/ticket/10914): Plugins [Indent List](https://ckeditor.com/cke4/addon/indentlist) and [Indent DirectorBlock](https://ckeditor.com/cke4/addon/indentblock) are now included in the build configuration.
...
- Both the Basic and the Standard distribution packages will not contain the new [Indent DirectorBlock](https://ckeditor.com/cke4/addon/indentblock) plugin. Because of this the [Advanced Content Filter](https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_advanced_content_filter) might remove block indentations from existing contents. If you want to prevent this, either [add an appropriate ACF rule to your filter](https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_allowed_content_rules) or create a custom build based on the Basic/Standard package and add the Indent DirectorBlock plugin in [CKBuilder](https://ckeditor.com/cke4/builder).

New Features:

- [#10027](https://dev.ckeditor.com/ticket/10027): Separated list and block indentation into two plugins: [Indent List](https://ckeditor.com/cke4/addon/indentlist) and [Indent DirectorBlock](https://ckeditor.com/cke4/addon/indentblock).
